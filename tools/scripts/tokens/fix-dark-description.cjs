...
const FOUNDATION_PATH = path.join(__dirname, '../../../packages/@dsai/tokens/figma-exports/foundation.json');

const WRONG_DESCRIPTION = 'Light theme color. Light backgrounds, subtle surfaces, and low-emphasis elements. Use for page backgrounds, card backgrounds, light UI surfaces. Bootstrap\'s --bs-light maps to gray-100. Provides subtle separation. Use with dark text (700+).';

const CORRECT_DESCRIPTION = 'Dark theme color. Dark backgrounds, strong surfaces, and high-emphasis elements. Use for page backgrounds, card backgrounds, and dark UI surfaces. Bootstrap\'s --bs-dark maps to gray-900. Provides strong contrast. Use with light text (100–300).';

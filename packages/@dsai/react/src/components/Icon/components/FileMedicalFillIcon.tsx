 ...
 * FileMedicalFillIcon
 *
 * Bootstrap Icons - File medical fill
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-medical-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileMedicalFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileMedicalFillIcon aria-label="File medical fill" />
 * ```
 */
...
export const FileMedicalFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileMedicalFillIcon.displayName = 'FileMedicalFillIcon';

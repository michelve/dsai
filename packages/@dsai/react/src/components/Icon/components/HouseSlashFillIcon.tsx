 ...
 * ```tsx
 * <Button startIcon={<HouseSlashFillIcon />}>Click me</Button>
 * ```
 *
...
export const HouseSlashFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HouseSlashFillIcon.displayName = 'HouseSlashFillIcon';

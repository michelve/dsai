 ...
 * ```tsx
 * <Button startIcon={<HouseExclamationFillIcon />}>Click me</Button>
 * ```
 *
...
export const HouseExclamationFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HouseExclamationFillIcon.displayName = 'HouseExclamationFillIcon';

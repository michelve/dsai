 ...
 * ```tsx
 * <Button startIcon={<FilterCircleIcon />}>Click me</Button>
 * ```
 *
...
export const FilterCircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FilterCircleIcon.displayName = 'FilterCircleIcon';

 ...
 * ```tsx
 * <Button startIcon={<Arrow90degUpIcon />}>Click me</Button>
 * ```
 *
...
export const Arrow90degUpIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Arrow90degUpIcon.displayName = 'Arrow90degUpIcon';

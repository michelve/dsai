 ...
 * ```tsx
 * <Button startIcon={<PersonArmsUpIcon />}>Click me</Button>
 * ```
 *
...
export const PersonArmsUpIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonArmsUpIcon.displayName = 'PersonArmsUpIcon';

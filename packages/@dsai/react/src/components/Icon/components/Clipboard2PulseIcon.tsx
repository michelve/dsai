 ...
 * ```tsx
 * <Button startIcon={<Clipboard2PulseIcon />}>Click me</Button>
 * ```
 *
...
export const Clipboard2PulseIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Clipboard2PulseIcon.displayName = 'Clipboard2PulseIcon';

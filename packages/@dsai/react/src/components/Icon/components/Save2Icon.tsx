 ...
 * Save2Icon
 *
 * Bootstrap Icons - Save2
 * @category UI and keyboard
 * @tags save
 * @see https://icons.getbootstrap.com/icons/save2/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Save2Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Save2Icon aria-label="Save2" />
 * ```
 */
...
export const Save2Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

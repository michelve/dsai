 ...
 * ```tsx
 * <Button startIcon={<ShieldFillExclamationIcon />}>Click me</Button>
 * ```
 *
...
export const ShieldFillExclamationIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ShieldFillExclamationIcon.displayName = 'ShieldFillExclamationIcon';

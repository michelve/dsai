 ...
 * @tags mail
 * @see https://icons.getbootstrap.com/icons/inboxes/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<InboxesIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <InboxesIcon aria-label="Inboxes fill" />
 * ```
 */
...
export const InboxesIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
InboxesIcon.displayName = 'InboxesIcon';

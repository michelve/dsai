 ...
 * TelephoneXFillIcon
 *
 * Bootstrap Icons - Telephone x fill
 * @category Communications
 * @tags telephone
 * @see https://icons.getbootstrap.com/icons/telephone-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TelephoneXFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TelephoneXFillIcon aria-label="Telephone x fill" />
 * ```
 */
...
export const TelephoneXFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TelephoneXFillIcon.displayName = 'TelephoneXFillIcon';

 ...
 * BagPlusIcon
 *
 * Bootstrap Icons - Bag plus
 * @category Commerce
 * @tags shopping
 * @see https://icons.getbootstrap.com/icons/bag-plus/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BagPlusIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BagPlusIcon aria-label="Bag plus" />
 * ```
 */
...
export const BagPlusIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

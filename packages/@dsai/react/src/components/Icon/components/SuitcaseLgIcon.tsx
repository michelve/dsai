 ...
 * SuitcaseLgIcon
 *
 * Bootstrap Icons - Suitcase lg
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/suitcase-lg/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SuitcaseLgIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SuitcaseLgIcon aria-label="Suitcase lg" />
 * ```
 */
...
export const SuitcaseLgIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SuitcaseLgIcon.displayName = 'SuitcaseLgIcon';

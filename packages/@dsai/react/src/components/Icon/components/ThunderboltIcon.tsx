 ...
 * ThunderboltIcon
 *
 * Bootstrap Icons - Thunderbolt
 * @category Devices
 * @tags plug
 * @see https://icons.getbootstrap.com/icons/thunderbolt/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ThunderboltIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ThunderboltIcon aria-label="Thunderbolt" />
 * ```
 */
...
export const ThunderboltIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * Icon6SquareIcon
 *
 * Bootstrap Icons - 6 square
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/6-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon6SquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon6SquareIcon aria-label="6 square" />
 * ```
 */
...
export const Icon6SquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon6SquareIcon.displayName = 'Icon6SquareIcon';

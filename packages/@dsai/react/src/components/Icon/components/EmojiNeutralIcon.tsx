 ...
 * EmojiNeutralIcon
 *
 * Bootstrap Icons - Emoji neutral
 * @category Emoji
 * @tags emoticon
 * @see https://icons.getbootstrap.com/icons/emoji-neutral/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EmojiNeutralIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EmojiNeutralIcon aria-label="Emoji neutral" />
 * ```
 */
...
export const EmojiNeutralIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<JournalBookmarkFillIcon />}>Click me</Button>
 * ```
 *
...
export const JournalBookmarkFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
JournalBookmarkFillIcon.displayName = 'JournalBookmarkFillIcon';

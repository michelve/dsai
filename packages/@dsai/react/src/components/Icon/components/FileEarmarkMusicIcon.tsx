 ...
 *
 * Bootstrap Icons - File earmark music
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-earmark-music/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkMusicIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileEarmarkMusicIcon aria-label="File earmark music" />
 * ```
 */
...
export const FileEarmarkMusicIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkMusicIcon.displayName = 'FileEarmarkMusicIcon';

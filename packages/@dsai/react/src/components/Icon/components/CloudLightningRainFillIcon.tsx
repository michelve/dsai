 ...
 * @category Weather
 * @tags thunder
 * @see https://icons.getbootstrap.com/icons/cloud-lightning-rain-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudLightningRainFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudLightningRainFillIcon aria-label="Cloud lightning rain fill" />
 * ```
 */
...
export const CloudLightningRainFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudLightningRainFillIcon.displayName = 'CloudLightningRainFillIcon';

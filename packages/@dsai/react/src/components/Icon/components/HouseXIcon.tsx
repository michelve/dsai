 ...
 * HouseXIcon
 *
 * Bootstrap Icons - House x
 * @category Real world
 * @tags home
 * @see https://icons.getbootstrap.com/icons/house-x/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HouseXIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HouseXIcon aria-label="House x" />
 * ```
 */
...
export const HouseXIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HouseXIcon.displayName = 'HouseXIcon';

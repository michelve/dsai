 ...
 * ```tsx
 * <Button startIcon={<ArrowUpLeftSquareFillIcon />}>Click me</Button>
 * ```
 *
...
export const ArrowUpLeftSquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowUpLeftSquareFillIcon.displayName = 'ArrowUpLeftSquareFillIcon';

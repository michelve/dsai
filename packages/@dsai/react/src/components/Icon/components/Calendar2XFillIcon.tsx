 ...
 * Calendar2XFillIcon
 *
 * Bootstrap Icons - Calendar2 x fill
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar2-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Calendar2XFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Calendar2XFillIcon aria-label="Calendar2 x fill" />
 * ```
 */
...
export const Calendar2XFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Calendar2XFillIcon.displayName = 'Calendar2XFillIcon';

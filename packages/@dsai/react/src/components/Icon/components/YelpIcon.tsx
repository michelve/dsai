 ...
 * YelpIcon
 *
 * Bootstrap Icons - Yelp
 * @category Brand
 * @tags social
 * @see https://icons.getbootstrap.com/icons/yelp/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<YelpIcon />}>Click me</Button>
 * ```
 *
...
export const YelpIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

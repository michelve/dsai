 ...
 * ```tsx
 * <Button startIcon={<SdCardFillIcon />}>Click me</Button>
 * ```
 *
...
export const SdCardFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SdCardFillIcon.displayName = 'SdCardFillIcon';

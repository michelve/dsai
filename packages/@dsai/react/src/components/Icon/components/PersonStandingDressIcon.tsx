 ...
 * ```tsx
 * <Button startIcon={<PersonStandingDressIcon />}>Click me</Button>
 * ```
 *
...
export const PersonStandingDressIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonStandingDressIcon.displayName = 'PersonStandingDressIcon';

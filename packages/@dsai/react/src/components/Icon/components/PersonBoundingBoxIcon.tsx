 ...
 * ```tsx
 * <Button startIcon={<PersonBoundingBoxIcon />}>Click me</Button>
 * ```
 *
...
export const PersonBoundingBoxIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonBoundingBoxIcon.displayName = 'PersonBoundingBoxIcon';

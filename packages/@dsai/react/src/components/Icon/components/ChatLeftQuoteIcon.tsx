 ...
 * ```tsx
 * <Button startIcon={<ChatLeftQuoteIcon />}>Click me</Button>
 * ```
 *
...
export const ChatLeftQuoteIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ChatLeftQuoteIcon.displayName = 'ChatLeftQuoteIcon';

 ...
 * ```tsx
 * <Button startIcon={<PersonVcardFillIcon />}>Click me</Button>
 * ```
 *
...
export const PersonVcardFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonVcardFillIcon.displayName = 'PersonVcardFillIcon';

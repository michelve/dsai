 ...
 * ```tsx
 * <Button startIcon={<SignMergeLeftFillIcon />}>Click me</Button>
 * ```
 *
...
export const SignMergeLeftFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignMergeLeftFillIcon.displayName = 'SignMergeLeftFillIcon';

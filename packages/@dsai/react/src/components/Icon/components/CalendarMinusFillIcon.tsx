 ...
 * ```tsx
 * <Button startIcon={<CalendarMinusFillIcon />}>Click me</Button>
 * ```
 *
...
export const CalendarMinusFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CalendarMinusFillIcon.displayName = 'CalendarMinusFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<ExclamationDiamondIcon />}>Click me</Button>
 * ```
 *
...
export const ExclamationDiamondIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ExclamationDiamondIcon.displayName = 'ExclamationDiamondIcon';

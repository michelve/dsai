 ...
 * ```tsx
 * <Button startIcon={<TelephoneOutboundFillIcon />}>Click me</Button>
 * ```
 *
...
export const TelephoneOutboundFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TelephoneOutboundFillIcon.displayName = 'TelephoneOutboundFillIcon';

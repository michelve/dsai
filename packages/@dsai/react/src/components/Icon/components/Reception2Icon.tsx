 ...
 * ```tsx
 * <Button startIcon={<Reception2Icon />}>Click me</Button>
 * ```
 *
...
export const Reception2Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Reception2Icon.displayName = 'Reception2Icon';

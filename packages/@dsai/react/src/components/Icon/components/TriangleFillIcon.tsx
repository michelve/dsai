 ...
 * ```tsx
 * <Button startIcon={<TriangleFillIcon />}>Click me</Button>
 * ```
 *
...
export const TriangleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TriangleFillIcon.displayName = 'TriangleFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<ArrowsAngleContractIcon />}>Click me</Button>
 * ```
 *
...
export const ArrowsAngleContractIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowsAngleContractIcon.displayName = 'ArrowsAngleContractIcon';

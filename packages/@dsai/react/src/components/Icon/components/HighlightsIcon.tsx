 ...
 * HighlightsIcon
 *
 * Bootstrap Icons - Highlights
 * @category Graphics
 * @tags photo
 * @see https://icons.getbootstrap.com/icons/highlights/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HighlightsIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HighlightsIcon aria-label="Highlights" />
 * ```
 */
...
export const HighlightsIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

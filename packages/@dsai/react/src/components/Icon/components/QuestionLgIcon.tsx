 ...
 * ```tsx
 * <Button startIcon={<QuestionLgIcon />}>Click me</Button>
 * ```
 *
...
export const QuestionLgIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
QuestionLgIcon.displayName = 'QuestionLgIcon';

 ...
 * ```tsx
 * <Button startIcon={<BrowserChromeIcon />}>Click me</Button>
 * ```
 *
...
export const BrowserChromeIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BrowserChromeIcon.displayName = 'BrowserChromeIcon';

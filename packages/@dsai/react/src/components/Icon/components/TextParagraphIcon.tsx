 ...
 * TextParagraphIcon
 *
 * Bootstrap Icons - Text paragraph
 * @category Typography
 * @tags text
 * @see https://icons.getbootstrap.com/icons/text-paragraph/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TextParagraphIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TextParagraphIcon aria-label="Text paragraph" />
 * ```
 */
...
export const TextParagraphIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

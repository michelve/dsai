 ...
 * ```tsx
 * <Button startIcon={<FilterSquareFillIcon />}>Click me</Button>
 * ```
 *
...
export const FilterSquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FilterSquareFillIcon.displayName = 'FilterSquareFillIcon';

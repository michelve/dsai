 ...
 * BorderRightIcon
 *
 * Bootstrap Icons - Border right
 * @category UI and keyboard
 * @tags borders
 * @see https://icons.getbootstrap.com/icons/border-right/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BorderRightIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BorderRightIcon aria-label="Border right" />
 * ```
 */
...
export const BorderRightIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

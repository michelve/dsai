 ...
 * ```tsx
 * <Button startIcon={<HospitalFillIcon />}>Click me</Button>
 * ```
 *
...
export const HospitalFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HospitalFillIcon.displayName = 'HospitalFillIcon';

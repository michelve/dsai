 ...
 * BackpackFillIcon
 *
 * Bootstrap Icons - Backpack fill
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/backpack-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BackpackFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BackpackFillIcon aria-label="Backpack fill" />
 * ```
 */
...
export const BackpackFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BackpackFillIcon.displayName = 'BackpackFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<FiletypeYmlIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypeYmlIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FiletypeYmlIcon.displayName = 'FiletypeYmlIcon';

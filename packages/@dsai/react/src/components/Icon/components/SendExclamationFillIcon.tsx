 ...
 * ```tsx
 * <Button startIcon={<SendExclamationFillIcon />}>Click me</Button>
 * ```
 *
...
export const SendExclamationFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SendExclamationFillIcon.displayName = 'SendExclamationFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<DashCircleIcon />}>Click me</Button>
 * ```
 *
...
export const DashCircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DashCircleIcon.displayName = 'DashCircleIcon';

 ...
 * ```tsx
 * <Button startIcon={<MusicNoteListIcon />}>Click me</Button>
 * ```
 *
...
export const MusicNoteListIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
MusicNoteListIcon.displayName = 'MusicNoteListIcon';

 ...
 * EnvelopeXFillIcon
 *
 * Bootstrap Icons - Envelope x fill
 * @category Communications
 * @tags email
 * @see https://icons.getbootstrap.com/icons/envelope-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EnvelopeXFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EnvelopeXFillIcon aria-label="Envelope x fill" />
 * ```
 */
...
export const EnvelopeXFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EnvelopeXFillIcon.displayName = 'EnvelopeXFillIcon';

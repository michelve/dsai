 ...
 * SignStopLightsIcon
 *
 * Bootstrap Icons - Sign stop lights
 * @category Transportation
 * @tags "stop sign"
 * @see https://icons.getbootstrap.com/icons/sign-stop-lights/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignStopLightsIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignStopLightsIcon aria-label="Sign stop lights" />
 * ```
 */
...
export const SignStopLightsIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignStopLightsIcon.displayName = 'SignStopLightsIcon';

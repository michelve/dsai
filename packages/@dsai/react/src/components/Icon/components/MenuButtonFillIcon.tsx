 ...
 * MenuButtonFillIcon
 *
 * Bootstrap Icons - Menu button fill
 * @category Controls
 * @tags dropdown
 * @see https://icons.getbootstrap.com/icons/menu-button-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<MenuButtonFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <MenuButtonFillIcon aria-label="Menu button fill" />
 * ```
 */
...
export const MenuButtonFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
MenuButtonFillIcon.displayName = 'MenuButtonFillIcon';

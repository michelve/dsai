 ...
 * CloudHaze2Icon
 *
 * Bootstrap Icons - Cloud haze2
 * @category Weather
 * @tags smog
 * @see https://icons.getbootstrap.com/icons/cloud-haze2/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudHaze2Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudHaze2Icon aria-label="Cloud haze2" />
 * ```
 */
...
export const CloudHaze2Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudHaze2Icon.displayName = 'CloudHaze2Icon';

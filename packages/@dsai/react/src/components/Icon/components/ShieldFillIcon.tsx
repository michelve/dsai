 ...
 * ShieldFillIcon
 *
 * Bootstrap Icons - Shield fill
 * @category Security
 * @tags privacy
 * @see https://icons.getbootstrap.com/icons/shield-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ShieldFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ShieldFillIcon aria-label="Shield fill" />
 * ```
 */
...
export const ShieldFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ShieldFillIcon.displayName = 'ShieldFillIcon';

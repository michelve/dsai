 ...
 * RSquareFillIcon
 *
 * Bootstrap Icons - R square fill
 * @category Shapes
 * @tags registered
 * @see https://icons.getbootstrap.com/icons/r-square-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<RSquareFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <RSquareFillIcon aria-label="R square fill" />
 * ```
 */
...
export const RSquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
RSquareFillIcon.displayName = 'RSquareFillIcon';

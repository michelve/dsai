 ...
 * @category Geo
 * @tags geography
 * @see https://icons.getbootstrap.com/icons/globe-asia-australia/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<GlobeAsiaAustraliaIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <GlobeAsiaAustraliaIcon aria-label="Globe Asia Australia" />
 * ```
 */
...
export const GlobeAsiaAustraliaIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

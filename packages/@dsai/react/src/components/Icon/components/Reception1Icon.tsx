 ...
 * ```tsx
 * <Button startIcon={<Reception1Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Reception1Icon aria-label="Reception1" />
 * ```
 */
...
export const Reception1Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Reception1Icon.displayName = 'Reception1Icon';

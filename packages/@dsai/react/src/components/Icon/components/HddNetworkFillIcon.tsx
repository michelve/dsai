 ...
 * ```tsx
 * <Button startIcon={<HddNetworkFillIcon />}>Click me</Button>
 * ```
 *
...
export const HddNetworkFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HddNetworkFillIcon.displayName = 'HddNetworkFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<AlignStartIcon />}>Click me</Button>
 * ```
 *
...
export const AlignStartIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
AlignStartIcon.displayName = 'AlignStartIcon';

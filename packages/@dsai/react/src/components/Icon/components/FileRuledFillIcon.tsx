 ...
 * ```tsx
 * <Button startIcon={<FileRuledFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileRuledFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileRuledFillIcon.displayName = 'FileRuledFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<FuelPumpDieselFillIcon />}>Click me</Button>
 * ```
 *
...
export const FuelPumpDieselFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FuelPumpDieselFillIcon.displayName = 'FuelPumpDieselFillIcon';

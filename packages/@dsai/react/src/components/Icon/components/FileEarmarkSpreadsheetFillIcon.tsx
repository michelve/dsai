 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkSpreadsheetFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileEarmarkSpreadsheetFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkSpreadsheetFillIcon.displayName = 'FileEarmarkSpreadsheetFillIcon';

 ...
 * PcHorizontalIcon
 *
 * Bootstrap Icons - PC horizontal
 * @category Devices
 * @tags computer
 * @see https://icons.getbootstrap.com/icons/pc-horizontal/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PcHorizontalIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PcHorizontalIcon aria-label="PC horizontal" />
 * ```
 */
...
export const PcHorizontalIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PcHorizontalIcon.displayName = 'PcHorizontalIcon';

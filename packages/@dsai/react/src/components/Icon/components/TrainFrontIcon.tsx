 ...
 * TrainFrontIcon
 *
 * Bootstrap Icons - Train front
 * @category Transportation
 * @tags transit
 * @see https://icons.getbootstrap.com/icons/train-front/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TrainFrontIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TrainFrontIcon aria-label="Train front" />
 * ```
 */
...
export const TrainFrontIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

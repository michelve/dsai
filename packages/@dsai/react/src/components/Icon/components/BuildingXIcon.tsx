 ...
 * BuildingXIcon
 *
 * Bootstrap Icons - Building x
 * @category Buildings
 * @tags company
 * @see https://icons.getbootstrap.com/icons/building-x/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BuildingXIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BuildingXIcon aria-label="Building x" />
 * ```
 */
...
export const BuildingXIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BuildingXIcon.displayName = 'BuildingXIcon';

 ...
 * ```tsx
 * <Button startIcon={<CassetteFillIcon />}>Click me</Button>
 * ```
 *
...
export const CassetteFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CassetteFillIcon.displayName = 'CassetteFillIcon';

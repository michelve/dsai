 ...
 *
 * Bootstrap Icons - File richtext fill
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-richtext-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileRichtextFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileRichtextFillIcon aria-label="File richtext fill" />
 * ```
 */
...
export const FileRichtextFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileRichtextFillIcon.displayName = 'FileRichtextFillIcon';

 ...
 * Clipboard2XFillIcon
 *
 * Bootstrap Icons - Clipboard2 x fill
 * @category Real world
 * @tags copy
 * @see https://icons.getbootstrap.com/icons/clipboard2-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Clipboard2XFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Clipboard2XFillIcon aria-label="Clipboard2 x fill" />
 * ```
 */
...
export const Clipboard2XFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Clipboard2XFillIcon.displayName = 'Clipboard2XFillIcon';

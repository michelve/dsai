 ...
 * ```tsx
 * <Button startIcon={<ConeStripedIcon />}>Click me</Button>
 * ```
 *
...
export const ConeStripedIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ConeStripedIcon.displayName = 'ConeStripedIcon';

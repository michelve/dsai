 ...
 * ```tsx
 * <Button startIcon={<Dice5FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Dice5FillIcon aria-label="Dice5Fill" />
 * ```
 */
...
export const Dice5FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Dice5FillIcon.displayName = 'Dice5FillIcon';

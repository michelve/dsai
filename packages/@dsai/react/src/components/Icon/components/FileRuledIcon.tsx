 ...
 * FileRuledIcon
 *
 * Bootstrap Icons - File ruled
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-ruled/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileRuledIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileRuledIcon aria-label="File ruled" />
 * ```
 */
...
export const FileRuledIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileRuledIcon.displayName = 'FileRuledIcon';

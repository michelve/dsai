 ...
 * TreeFillIcon
 *
 * Bootstrap Icons - Tree fill
 * @category Real world
 * @tags tree
 * @see https://icons.getbootstrap.com/icons/tree-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TreeFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TreeFillIcon aria-label="Tree fill" />
 * ```
 */
...
export const TreeFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TreeFillIcon.displayName = 'TreeFillIcon';

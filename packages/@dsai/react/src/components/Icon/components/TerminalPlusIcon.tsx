 ...
 * ```tsx
 * <Button startIcon={<TerminalPlusIcon />}>Click me</Button>
 * ```
 *
...
export const TerminalPlusIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TerminalPlusIcon.displayName = 'TerminalPlusIcon';

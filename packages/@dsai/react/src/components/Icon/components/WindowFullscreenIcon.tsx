 ...
 * ```tsx
 * <Button startIcon={<WindowFullscreenIcon />}>Click me</Button>
 * ```
 *
...
export const WindowFullscreenIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
WindowFullscreenIcon.displayName = 'WindowFullscreenIcon';

 ...
 * ```tsx
 * <Button startIcon={<InputCursorTextIcon />}>Click me</Button>
 * ```
 *
...
export const InputCursorTextIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
InputCursorTextIcon.displayName = 'InputCursorTextIcon';

 ...
 * @category Buildings
 * @tags company
 * @see https://icons.getbootstrap.com/icons/building-slash/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BuildingSlashIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BuildingSlashIcon aria-label="Building slash" />
 * ```
 */
...
export const BuildingSlashIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BuildingSlashIcon.displayName = 'BuildingSlashIcon';

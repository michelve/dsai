 ...
 * ```tsx
 * <Button startIcon={<EmojiLaughingFillIcon />}>Click me</Button>
 * ```
 *
...
export const EmojiLaughingFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EmojiLaughingFillIcon.displayName = 'EmojiLaughingFillIcon';

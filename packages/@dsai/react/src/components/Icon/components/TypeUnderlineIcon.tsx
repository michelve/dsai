 ...
 * ```tsx
 * <Button startIcon={<TypeUnderlineIcon />}>Click me</Button>
 * ```
 *
...
export const TypeUnderlineIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TypeUnderlineIcon.displayName = 'TypeUnderlineIcon';

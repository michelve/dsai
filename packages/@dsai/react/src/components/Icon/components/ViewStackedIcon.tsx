 ...
 * ```tsx
 * <Button startIcon={<ViewStackedIcon />}>Click me</Button>
 * ```
 *
...
export const ViewStackedIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ViewStackedIcon.displayName = 'ViewStackedIcon';

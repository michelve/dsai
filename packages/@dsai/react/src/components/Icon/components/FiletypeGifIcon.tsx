 ...
 * FiletypeGifIcon
 *
 * Bootstrap Icons - Filetype gif
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-gif/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeGifIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeGifIcon aria-label="Filetype gif" />
 * ```
 */
...
export const FiletypeGifIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FiletypeGifIcon.displayName = 'FiletypeGifIcon';

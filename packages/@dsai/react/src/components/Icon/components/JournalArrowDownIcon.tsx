 ...
 * ```tsx
 * <Button startIcon={<JournalArrowDownIcon />}>Click me</Button>
 * ```
 *
...
export const JournalArrowDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
JournalArrowDownIcon.displayName = 'JournalArrowDownIcon';

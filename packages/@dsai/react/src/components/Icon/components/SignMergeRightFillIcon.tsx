 ...
 *
 * Bootstrap Icons - Sign merge right fill
 * @category Transportation
 * @tags road
 * @see https://icons.getbootstrap.com/icons/sign-merge-right-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignMergeRightFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignMergeRightFillIcon aria-label="Sign merge right fill" />
 * ```
 */
...
export const SignMergeRightFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignMergeRightFillIcon.displayName = 'SignMergeRightFillIcon';

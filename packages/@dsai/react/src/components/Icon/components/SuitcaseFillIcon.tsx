 ...
 * SuitcaseFillIcon
 *
 * Bootstrap Icons - Suitcase fill
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/suitcase-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SuitcaseFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SuitcaseFillIcon aria-label="Suitcase fill" />
 * ```
 */
...
export const SuitcaseFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SuitcaseFillIcon.displayName = 'SuitcaseFillIcon';

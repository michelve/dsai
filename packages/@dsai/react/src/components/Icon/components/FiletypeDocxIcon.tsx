 ...
 * FiletypeDocxIcon
 *
 * Bootstrap Icons - Filetype docx
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-docx/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeDocxIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeDocxIcon aria-label="Filetype docx" />
 * ```
 */
...
export const FiletypeDocxIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * BadgeAdIcon
 *
 * Bootstrap Icons - Badge ad
 * @category Badges
 * @tags advertisement
 * @see https://icons.getbootstrap.com/icons/badge-ad/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BadgeAdIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BadgeAdIcon aria-label="Badge ad" />
 * ```
 */
...
export const BadgeAdIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

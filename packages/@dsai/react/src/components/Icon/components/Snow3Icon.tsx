 ...
 * Snow3Icon
 *
 * Bootstrap Icons - Snow3
 * @category Weather
 * @tags blizzard
 * @see https://icons.getbootstrap.com/icons/snow3/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Snow3Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Snow3Icon aria-label="Snow3" />
 * ```
 */
...
export const Snow3Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Snow3Icon.displayName = 'Snow3Icon';

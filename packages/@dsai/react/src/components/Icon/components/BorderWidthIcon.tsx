 ...
 * ```tsx
 * <Button startIcon={<BorderWidthIcon />}>Click me</Button>
 * ```
 *
...
export const BorderWidthIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BorderWidthIcon.displayName = 'BorderWidthIcon';

 ...
 * ```tsx
 * <Button startIcon={<SendArrowDownIcon />}>Click me</Button>
 * ```
 *
...
export const SendArrowDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SendArrowDownIcon.displayName = 'SendArrowDownIcon';

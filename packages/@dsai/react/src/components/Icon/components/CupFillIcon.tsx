 ...
 * CupFillIcon
 *
 * Bootstrap Icons - Cup fill
 * @category Real world
 * @tags mug
 * @see https://icons.getbootstrap.com/icons/cup-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CupFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CupFillIcon aria-label="Cup fill" />
 * ```
 */
...
export const CupFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CupFillIcon.displayName = 'CupFillIcon';

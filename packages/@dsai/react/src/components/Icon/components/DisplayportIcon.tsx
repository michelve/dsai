 ...
 * ```tsx
 * <Button startIcon={<DisplayportIcon />}>Click me</Button>
 * ```
 *
...
export const DisplayportIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DisplayportIcon.displayName = 'DisplayportIcon';

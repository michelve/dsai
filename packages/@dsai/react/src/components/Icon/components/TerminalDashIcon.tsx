 ...
 * ```tsx
 * <Button startIcon={<TerminalDashIcon />}>Click me</Button>
 * ```
 *
...
export const TerminalDashIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TerminalDashIcon.displayName = 'TerminalDashIcon';

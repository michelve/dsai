 ...
 * Calendar2XIcon
 *
 * Bootstrap Icons - Calendar2 x
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar2-x/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Calendar2XIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Calendar2XIcon aria-label="Calendar2 x" />
 * ```
 */
...
export const Calendar2XIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Calendar2XIcon.displayName = 'Calendar2XIcon';

 ...
 * @tags road
 * @see https://icons.getbootstrap.com/icons/sign-do-not-enter-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignDoNotEnterFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignDoNotEnterFillIcon aria-label="Sign do not enter fill" />
 * ```
 */
...
export const SignDoNotEnterFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignDoNotEnterFillIcon.displayName = 'SignDoNotEnterFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<EnvelopeDashFillIcon />}>Click me</Button>
 * ```
 *
...
export const EnvelopeDashFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EnvelopeDashFillIcon.displayName = 'EnvelopeDashFillIcon';

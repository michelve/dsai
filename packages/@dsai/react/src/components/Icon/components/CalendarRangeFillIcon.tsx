 ...
 * ```tsx
 * <Button startIcon={<CalendarRangeFillIcon />}>Click me</Button>
 * ```
 *
...
export const CalendarRangeFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CalendarRangeFillIcon.displayName = 'CalendarRangeFillIcon';

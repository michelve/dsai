 ...
 * ```tsx
 * <Button startIcon={<BadgeArFillIcon />}>Click me</Button>
 * ```
 *
...
export const BadgeArFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BadgeArFillIcon.displayName = 'BadgeArFillIcon';

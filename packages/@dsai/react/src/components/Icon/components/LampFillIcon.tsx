 ...
 * LampFillIcon
 *
 * Bootstrap Icons - Lamp fill
 * @category Real world
 * @tags light
 * @see https://icons.getbootstrap.com/icons/lamp-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<LampFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <LampFillIcon aria-label="Lamp fill" />
 * ```
 */
...
export const LampFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
LampFillIcon.displayName = 'LampFillIcon';

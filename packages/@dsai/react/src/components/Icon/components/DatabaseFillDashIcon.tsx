 ...
 *
 * Bootstrap Icons - Database fill dash
 * @category Devices
 * @tags server
 * @see https://icons.getbootstrap.com/icons/database-fill-dash/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DatabaseFillDashIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DatabaseFillDashIcon aria-label="Database fill dash" />
 * ```
 */
...
export const DatabaseFillDashIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DatabaseFillDashIcon.displayName = 'DatabaseFillDashIcon';

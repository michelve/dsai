 ...
 * ```tsx
 * <Button startIcon={<SignTurnLeftFillIcon />}>Click me</Button>
 * ```
 *
...
export const SignTurnLeftFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignTurnLeftFillIcon.displayName = 'SignTurnLeftFillIcon';

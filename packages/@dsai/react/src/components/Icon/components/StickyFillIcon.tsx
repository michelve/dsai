 ...
 * ```tsx
 * <Button startIcon={<StickyFillIcon />}>Click me</Button>
 * ```
 *
...
export const StickyFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
StickyFillIcon.displayName = 'StickyFillIcon';

 ...
 * HeartbreakIcon
 *
 * Bootstrap Icons - Heartbreak
 * @category Emoji
 * @tags love
 * @see https://icons.getbootstrap.com/icons/heartbreak/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HeartbreakIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HeartbreakIcon aria-label="Heartbreak" />
 * ```
 */
...
export const HeartbreakIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

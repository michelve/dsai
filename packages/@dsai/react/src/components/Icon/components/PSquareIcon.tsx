 ...
 * PSquareIcon
 *
 * Bootstrap Icons - P square
 * @category Shapes
 * @tags parking
 * @see https://icons.getbootstrap.com/icons/p-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PSquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PSquareIcon aria-label="P square" />
 * ```
 */
...
export const PSquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PSquareIcon.displayName = 'PSquareIcon';

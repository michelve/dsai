 ...
 * ```tsx
 * <Button startIcon={<InboxesFillIcon />}>Click me</Button>
 * ```
 *
...
export const InboxesFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
InboxesFillIcon.displayName = 'InboxesFillIcon';

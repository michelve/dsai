 ...
 *
 * Bootstrap Icons - Globe Central South Asia
 * @category Geo
 * @tags geography
 * @see https://icons.getbootstrap.com/icons/globe-central-south-asia/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<GlobeCentralSouthAsiaIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <GlobeCentralSouthAsiaIcon aria-label="Globe Central South Asia" />
 * ```
 */
...
export const GlobeCentralSouthAsiaIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
GlobeCentralSouthAsiaIcon.displayName = 'GlobeCentralSouthAsiaIcon';

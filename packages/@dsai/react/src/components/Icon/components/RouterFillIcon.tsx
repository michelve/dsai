 ...
 * ```tsx
 * <Button startIcon={<RouterFillIcon />}>Click me</Button>
 * ```
 *
...
export const RouterFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
RouterFillIcon.displayName = 'RouterFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<SignNoParkingFillIcon />}>Click me</Button>
 * ```
 *
...
export const SignNoParkingFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignNoParkingFillIcon.displayName = 'SignNoParkingFillIcon';

 ...
 * PersonDownIcon
 *
 * Bootstrap Icons - Person down
 * @category People
 * @tags member
 * @see https://icons.getbootstrap.com/icons/person-down/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PersonDownIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PersonDownIcon aria-label="Person down" />
 * ```
 */
...
export const PersonDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonDownIcon.displayName = 'PersonDownIcon';

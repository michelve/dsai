 ...
 * ```tsx
 * <Button startIcon={<BuildingFillLockIcon />}>Click me</Button>
 * ```
 *
...
export const BuildingFillLockIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BuildingFillLockIcon.displayName = 'BuildingFillLockIcon';

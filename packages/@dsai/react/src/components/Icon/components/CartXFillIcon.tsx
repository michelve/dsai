 ...
 * CartXFillIcon
 *
 * Bootstrap Icons - Cart x fill
 * @category Commerce
 * @tags shopping
 * @see https://icons.getbootstrap.com/icons/cart-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CartXFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CartXFillIcon aria-label="Cart x fill" />
 * ```
 */
...
export const CartXFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CartXFillIcon.displayName = 'CartXFillIcon';

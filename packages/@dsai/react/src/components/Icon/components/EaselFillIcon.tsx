 ...
 * EaselFillIcon
 *
 * Bootstrap Icons - Easel fill
 * @category Graphics
 * @tags paint
 * @see https://icons.getbootstrap.com/icons/easel-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EaselFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EaselFillIcon aria-label="Easel fill" />
 * ```
 */
...
export const EaselFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

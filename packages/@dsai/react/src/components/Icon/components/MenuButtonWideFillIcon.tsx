 ...
 * ```tsx
 * <Button startIcon={<MenuButtonWideFillIcon />}>Click me</Button>
 * ```
 *
...
export const MenuButtonWideFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
MenuButtonWideFillIcon.displayName = 'MenuButtonWideFillIcon';

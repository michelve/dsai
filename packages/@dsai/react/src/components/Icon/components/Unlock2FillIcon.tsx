 ...
 * ```tsx
 * <Button startIcon={<Unlock2FillIcon />}>Click me</Button>
 * ```
 *
...
export const Unlock2FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Unlock2FillIcon.displayName = 'Unlock2FillIcon';

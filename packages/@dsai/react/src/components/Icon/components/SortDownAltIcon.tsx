 ...
 * ```tsx
 * <Button startIcon={<SortDownAltIcon />}>Click me</Button>
 * ```
 *
...
export const SortDownAltIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SortDownAltIcon.displayName = 'SortDownAltIcon';

 ...
 * ```tsx
 * <Button startIcon={<BrowserFirefoxIcon />}>Click me</Button>
 * ```
 *
...
export const BrowserFirefoxIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BrowserFirefoxIcon.displayName = 'BrowserFirefoxIcon';

 ...
 * ```tsx
 * <Button startIcon={<WindowPlusIcon />}>Click me</Button>
 * ```
 *
...
export const WindowPlusIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
WindowPlusIcon.displayName = 'WindowPlusIcon';

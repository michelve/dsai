 ...
 * ```tsx
 * <Button startIcon={<FileExcelFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileExcelFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileExcelFillIcon.displayName = 'FileExcelFillIcon';

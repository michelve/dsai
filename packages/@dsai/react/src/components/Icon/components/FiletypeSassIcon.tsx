 ...
 * FiletypeSassIcon
 *
 * Bootstrap Icons - Filetype sass
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-sass/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeSassIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeSassIcon aria-label="Filetype sass" />
 * ```
 */
...
export const FiletypeSassIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FiletypeSassIcon.displayName = 'FiletypeSassIcon';

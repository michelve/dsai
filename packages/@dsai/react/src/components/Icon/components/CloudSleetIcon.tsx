 ...
 * ```tsx
 * <Button startIcon={<CloudSleetIcon />}>Click me</Button>
 * ```
 *
...
export const CloudSleetIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudSleetIcon.displayName = 'CloudSleetIcon';

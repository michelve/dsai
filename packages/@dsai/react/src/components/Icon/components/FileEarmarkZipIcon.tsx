 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkZipIcon />}>Click me</Button>
 * ```
 *
...
export const FileEarmarkZipIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkZipIcon.displayName = 'FileEarmarkZipIcon';

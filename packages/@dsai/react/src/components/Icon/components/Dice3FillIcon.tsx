 ...
 * ```tsx
 * <Button startIcon={<Dice3FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Dice3FillIcon aria-label="Dice3Fill" />
 * ```
 */
...
export const Dice3FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Dice3FillIcon.displayName = 'Dice3FillIcon';

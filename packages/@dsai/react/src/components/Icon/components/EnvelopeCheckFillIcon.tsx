 ...
 * ```tsx
 * <Button startIcon={<EnvelopeCheckFillIcon />}>Click me</Button>
 * ```
 *
...
export const EnvelopeCheckFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EnvelopeCheckFillIcon.displayName = 'EnvelopeCheckFillIcon';

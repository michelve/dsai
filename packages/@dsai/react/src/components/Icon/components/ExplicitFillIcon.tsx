 ...
 * ```tsx
 * <Button startIcon={<ExplicitFillIcon />}>Click me</Button>
 * ```
 *
...
export const ExplicitFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ExplicitFillIcon.displayName = 'ExplicitFillIcon';

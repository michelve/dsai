 ...
 * ```tsx
 * <Button startIcon={<PersonFillDashIcon />}>Click me</Button>
 * ```
 *
...
export const PersonFillDashIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonFillDashIcon.displayName = 'PersonFillDashIcon';

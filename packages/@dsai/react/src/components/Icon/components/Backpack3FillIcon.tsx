 ...
 * Backpack3FillIcon
 *
 * Bootstrap Icons - Backpack3 fill
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/backpack3-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Backpack3FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Backpack3FillIcon aria-label="Backpack3 fill" />
 * ```
 */
...
export const Backpack3FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Backpack3FillIcon.displayName = 'Backpack3FillIcon';

 ...
 * SafeIcon
 *
 * Bootstrap Icons - Safe
 * @category Real world
 * @tags vault
 * @see https://icons.getbootstrap.com/icons/safe/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SafeIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SafeIcon aria-label="Safe" />
 * ```
 */
...
export const SafeIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<CloudLightningRainIcon />}>Click me</Button>
 * ```
 *
...
export const CloudLightningRainIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudLightningRainIcon.displayName = 'CloudLightningRainIcon';

 ...
 * ToggleOffIcon
 *
 * Bootstrap Icons - Toggle off
 * @category Controls
 * @tags toggle
 * @see https://icons.getbootstrap.com/icons/toggle-off/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ToggleOffIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ToggleOffIcon aria-label="Toggle off" />
 * ```
 */

 ...
 * ```tsx
 * <Button startIcon={<LayoutSidebarInsetReverseIcon />}>Click me</Button>
 * ```
 *
...
export const LayoutSidebarInsetReverseIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
LayoutSidebarInsetReverseIcon.displayName = 'LayoutSidebarInsetReverseIcon';

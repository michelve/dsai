 ...
 * ```tsx
 * <Button startIcon={<SendCheckFillIcon />}>Click me</Button>
 * ```
 *
...
export const SendCheckFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SendCheckFillIcon.displayName = 'SendCheckFillIcon';

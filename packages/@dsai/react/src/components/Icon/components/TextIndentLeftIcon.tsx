 ...
 * TextIndentLeftIcon
 *
 * Bootstrap Icons - Text indent left
 * @category Typography
 * @tags text
 * @see https://icons.getbootstrap.com/icons/text-indent-left/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TextIndentLeftIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TextIndentLeftIcon aria-label="Text indent left" />
 * ```
 */
...
export const TextIndentLeftIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

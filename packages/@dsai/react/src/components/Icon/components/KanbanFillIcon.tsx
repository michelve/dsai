 ...
 * ```tsx
 * <Button startIcon={<KanbanFillIcon />}>Click me</Button>
 * ```
 *
...
export const KanbanFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
KanbanFillIcon.displayName = 'KanbanFillIcon';

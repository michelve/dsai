 ...
 * Icon4CircleIcon
 *
 * Bootstrap Icons - 4 circle
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/4-circle/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon4CircleIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon4CircleIcon aria-label="4 circle" />
 * ```
 */
...
export const Icon4CircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon4CircleIcon.displayName = 'Icon4CircleIcon';

 ...
 * ```tsx
 * <Button startIcon={<Grid3x2GapIcon />}>Click me</Button>
 * ```
 *
...
export const Grid3x2GapIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Grid3x2GapIcon.displayName = 'Grid3x2GapIcon';

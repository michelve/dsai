 ...
 * Backpack4FillIcon
 *
 * Bootstrap Icons - Backpack4 fill
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/backpack4-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Backpack4FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Backpack4FillIcon aria-label="Backpack4 fill" />
 * ```
 */
...
export const Backpack4FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Backpack4FillIcon.displayName = 'Backpack4FillIcon';

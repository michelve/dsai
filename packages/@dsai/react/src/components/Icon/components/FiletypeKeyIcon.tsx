 ...
 * ```tsx
 * <Button startIcon={<FiletypeKeyIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypeKeyIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FiletypeKeyIcon.displayName = 'FiletypeKeyIcon';

 ...
 * ```tsx
 * <Button startIcon={<ThermometerSnowIcon />}>Click me</Button>
 * ```
 *
...
export const ThermometerSnowIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ThermometerSnowIcon.displayName = 'ThermometerSnowIcon';

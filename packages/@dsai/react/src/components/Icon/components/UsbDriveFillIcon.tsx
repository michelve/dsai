 ...
 * ```tsx
 * <Button startIcon={<UsbDriveFillIcon />}>Click me</Button>
 * ```
 *
...
export const UsbDriveFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
UsbDriveFillIcon.displayName = 'UsbDriveFillIcon';

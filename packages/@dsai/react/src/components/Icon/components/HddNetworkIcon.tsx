 ...
 * @category Devices
 * @tags "hard drive"
 * @see https://icons.getbootstrap.com/icons/hdd-network/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HddNetworkIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HddNetworkIcon aria-label="Hdd network" />
 * ```
 */
...
export const HddNetworkIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HddNetworkIcon.displayName = 'HddNetworkIcon';

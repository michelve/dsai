 ...
 * ```tsx
 * <Button startIcon={<CloudCheckFillIcon />}>Click me</Button>
 * ```
 *
...
export const CloudCheckFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudCheckFillIcon.displayName = 'CloudCheckFillIcon';

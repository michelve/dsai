 ...
 *
 * Bootstrap Icons - Database fill gear
 * @category Devices
 * @tags server
 * @see https://icons.getbootstrap.com/icons/database-fill-gear/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DatabaseFillGearIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DatabaseFillGearIcon aria-label="Database fill gear" />
 * ```
 */
...
export const DatabaseFillGearIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DatabaseFillGearIcon.displayName = 'DatabaseFillGearIcon';

 ...
 * ```tsx
 * <Button startIcon={<ForwardFillIcon />}>Click me</Button>
 * ```
 *
...
export const ForwardFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ForwardFillIcon.displayName = 'ForwardFillIcon';

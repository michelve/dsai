 ...
 * VolumeMuteIcon
 *
 * Bootstrap Icons - Volume mute
 * @category Media
 * @tags audio
 * @see https://icons.getbootstrap.com/icons/volume-mute/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<VolumeMuteIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <VolumeMuteIcon aria-label="Volume mute" />
 * ```
 */

 ...
 * BriefcaseIcon
 *
 * Bootstrap Icons - Briefcase
 * @category Real world
 * @tags business
 * @see https://icons.getbootstrap.com/icons/briefcase/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BriefcaseIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BriefcaseIcon aria-label="Briefcase" />
 * ```
 */

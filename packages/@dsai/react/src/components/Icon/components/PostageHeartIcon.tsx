 ...
 * ```tsx
 * <Button startIcon={<PostageHeartIcon />}>Click me</Button>
 * ```
 *
...
export const PostageHeartIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PostageHeartIcon.displayName = 'PostageHeartIcon';

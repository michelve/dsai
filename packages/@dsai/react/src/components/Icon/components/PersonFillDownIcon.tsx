 ...
 * ```tsx
 * <Button startIcon={<PersonFillDownIcon />}>Click me</Button>
 * ```
 *
...
export const PersonFillDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonFillDownIcon.displayName = 'PersonFillDownIcon';

 ...
 * ```tsx
 * <Button startIcon={<MusicPlayerFillIcon />}>Click me</Button>
 * ```
 *
...
export const MusicPlayerFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
MusicPlayerFillIcon.displayName = 'MusicPlayerFillIcon';

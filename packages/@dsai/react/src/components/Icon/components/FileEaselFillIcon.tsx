 ...
 * ```tsx
 * <Button startIcon={<FileEaselFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileEaselFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEaselFillIcon.displayName = 'FileEaselFillIcon';

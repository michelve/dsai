 ...
 * ```tsx
 * <Button startIcon={<EyeglassesIcon />}>Click me</Button>
 * ```
 *
...
export const EyeglassesIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EyeglassesIcon.displayName = 'EyeglassesIcon';

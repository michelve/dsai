 ...
 * @category Weather
 * @tags cloud
 * @see https://icons.getbootstrap.com/icons/cloud-snow-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudSnowFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudSnowFillIcon aria-label="Cloud snow fill" />
 * ```
 */
...
export const CloudSnowFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudSnowFillIcon.displayName = 'CloudSnowFillIcon';

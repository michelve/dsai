 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkPdfFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileEarmarkPdfFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkPdfFillIcon.displayName = 'FileEarmarkPdfFillIcon';

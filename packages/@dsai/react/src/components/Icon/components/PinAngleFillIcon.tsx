 ...
 * ```tsx
 * <Button startIcon={<PinAngleFillIcon />}>Click me</Button>
 * ```
 *
...
export const PinAngleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PinAngleFillIcon.displayName = 'PinAngleFillIcon';

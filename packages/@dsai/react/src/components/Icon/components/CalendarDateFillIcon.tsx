 ...
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar-date-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CalendarDateFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CalendarDateFillIcon aria-label="Calendar date fill" />
 * ```
 */
...
export const CalendarDateFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CalendarDateFillIcon.displayName = 'CalendarDateFillIcon';

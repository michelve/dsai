 ...
 * SendXFillIcon
 *
 * Bootstrap Icons - Send x fill
 * @category Communications
 * @tags message
 * @see https://icons.getbootstrap.com/icons/send-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SendXFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SendXFillIcon aria-label="Send x fill" />
 * ```
 */
...
export const SendXFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SendXFillIcon.displayName = 'SendXFillIcon';

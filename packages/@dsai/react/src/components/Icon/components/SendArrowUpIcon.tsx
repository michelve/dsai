 ...
 * SendArrowUpIcon
 *
 * Bootstrap Icons - Send arrow up
 * @category Communications
 * @tags message
 * @see https://icons.getbootstrap.com/icons/send-arrow-up/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SendArrowUpIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SendArrowUpIcon aria-label="Send arrow up" />
 * ```
 */
...
export const SendArrowUpIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SendArrowUpIcon.displayName = 'SendArrowUpIcon';

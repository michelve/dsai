 ...
 * ```tsx
 * <Button startIcon={<TelephoneForwardFillIcon />}>Click me</Button>
 * ```
 *
...
export const TelephoneForwardFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TelephoneForwardFillIcon.displayName = 'TelephoneForwardFillIcon';

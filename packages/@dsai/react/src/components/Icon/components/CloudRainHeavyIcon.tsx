 ...
 * ```tsx
 * <Button startIcon={<CloudRainHeavyIcon />}>Click me</Button>
 * ```
 *
...
export const CloudRainHeavyIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudRainHeavyIcon.displayName = 'CloudRainHeavyIcon';

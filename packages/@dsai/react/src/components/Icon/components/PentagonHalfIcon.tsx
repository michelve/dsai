 ...
 * ```tsx
 * <Button startIcon={<PentagonHalfIcon />}>Click me</Button>
 * ```
 *
...
export const PentagonHalfIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PentagonHalfIcon.displayName = 'PentagonHalfIcon';

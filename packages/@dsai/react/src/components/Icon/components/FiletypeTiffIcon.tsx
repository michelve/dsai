 ...
 * ```tsx
 * <Button startIcon={<FiletypeTiffIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypeTiffIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FiletypeTiffIcon.displayName = 'FiletypeTiffIcon';

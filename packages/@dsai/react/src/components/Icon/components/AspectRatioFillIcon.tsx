 ...
 * ```tsx
 * <Button startIcon={<AspectRatioFillIcon />}>Click me</Button>
 * ```
 *
...
export const AspectRatioFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
AspectRatioFillIcon.displayName = 'AspectRatioFillIcon';

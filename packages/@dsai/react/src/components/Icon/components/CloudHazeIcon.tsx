 ...
 * CloudHazeIcon
 *
 * Bootstrap Icons - Cloud haze
 * @category Weather
 * @tags smog
 * @see https://icons.getbootstrap.com/icons/cloud-haze/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudHazeIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudHazeIcon aria-label="Cloud haze" />
 * ```
 */
...
export const CloudHazeIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudHazeIcon.displayName = 'CloudHazeIcon';

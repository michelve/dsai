 ...
 * ```tsx
 * <Button startIcon={<ArrowThroughHeartFillIcon />}>Click me</Button>
 * ```
 *
...
export const ArrowThroughHeartFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowThroughHeartFillIcon.displayName = 'ArrowThroughHeartFillIcon';

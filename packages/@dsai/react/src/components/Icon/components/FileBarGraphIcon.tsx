 ...
 * FileBarGraphIcon
 *
 * Bootstrap Icons - File bar graph
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-bar-graph/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileBarGraphIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileBarGraphIcon aria-label="File bar graph" />
 * ```
 */
...
export const FileBarGraphIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileBarGraphIcon.displayName = 'FileBarGraphIcon';

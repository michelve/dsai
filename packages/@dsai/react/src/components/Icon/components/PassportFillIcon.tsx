 ...
 * ```tsx
 * <Button startIcon={<PassportFillIcon />}>Click me</Button>
 * ```
 *
...
export const PassportFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PassportFillIcon.displayName = 'PassportFillIcon';

 ...
 * NodePlusFillIcon
 *
 * Bootstrap Icons - Node plus fill
 * @category Graphics
 * @tags add
 * @see https://icons.getbootstrap.com/icons/node-plus-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<NodePlusFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <NodePlusFillIcon aria-label="Node plus fill" />
 * ```
 */
...
export const NodePlusFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
NodePlusFillIcon.displayName = 'NodePlusFillIcon';

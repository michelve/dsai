 ...
 * Backpack4Icon
 *
 * Bootstrap Icons - Backpack4
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/backpack4/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Backpack4Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Backpack4Icon aria-label="Backpack4" />
 * ```
 */
...
export const Backpack4Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Backpack4Icon.displayName = 'Backpack4Icon';

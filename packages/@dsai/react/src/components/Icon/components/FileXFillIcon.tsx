 ...
 * FileXFillIcon
 *
 * Bootstrap Icons - File x fill
 * @category Files and folders
 * @tags document
 * @see https://icons.getbootstrap.com/icons/file-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileXFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileXFillIcon aria-label="File x fill" />
 * ```
 */
...
export const FileXFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileXFillIcon.displayName = 'FileXFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<PostcardHeartFillIcon />}>Click me</Button>
 * ```
 *
...
export const PostcardHeartFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PostcardHeartFillIcon.displayName = 'PostcardHeartFillIcon';

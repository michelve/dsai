 ...
 * ```tsx
 * <Button startIcon={<BuildingFillDownIcon />}>Click me</Button>
 * ```
 *
...
export const BuildingFillDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BuildingFillDownIcon.displayName = 'BuildingFillDownIcon';

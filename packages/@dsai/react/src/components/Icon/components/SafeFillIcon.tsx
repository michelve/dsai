 ...
 * SafeFillIcon
 *
 * Bootstrap Icons - Safe fill
 * @category Real world
 * @tags vault
 * @see https://icons.getbootstrap.com/icons/safe-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SafeFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SafeFillIcon aria-label="Safe fill" />
 * ```
 */
...
export const SafeFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SafeFillIcon.displayName = 'SafeFillIcon';

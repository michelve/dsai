 ...
 * @category Typography
 * @tags text
 * @see https://icons.getbootstrap.com/icons/list-columns/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ListColumnsIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ListColumnsIcon aria-label="List columns" />
 * ```
 */
...
export const ListColumnsIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ListColumnsIcon.displayName = 'ListColumnsIcon';

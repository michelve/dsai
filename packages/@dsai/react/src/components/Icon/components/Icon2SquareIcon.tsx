 ...
 * ```tsx
 * <Button startIcon={<Icon2SquareIcon />}>Click me</Button>
 * ```
 *
...
export const Icon2SquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon2SquareIcon.displayName = 'Icon2SquareIcon';

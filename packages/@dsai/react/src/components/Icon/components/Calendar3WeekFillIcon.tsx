 ...
 * ```tsx
 * <Button startIcon={<Calendar3WeekFillIcon />}>Click me</Button>
 * ```
 *
...
export const Calendar3WeekFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Calendar3WeekFillIcon.displayName = 'Calendar3WeekFillIcon';

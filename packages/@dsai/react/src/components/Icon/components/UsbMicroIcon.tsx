 ...
 * UsbMicroIcon
 *
 * Bootstrap Icons - USB micro
 * @category Devices
 * @tags port
 * @see https://icons.getbootstrap.com/icons/usb-micro/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<UsbMicroIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <UsbMicroIcon aria-label="USB micro" />
 * ```
 */
...
export const UsbMicroIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
UsbMicroIcon.displayName = 'UsbMicroIcon';

 ...
 * UnionIcon
 *
 * Bootstrap Icons - Union
 * @category Graphics
 * @tags graphics
 * @see https://icons.getbootstrap.com/icons/union/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<UnionIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <UnionIcon aria-label="Union" />
 * ```
 */
...
export const UnionIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<SymmetryVerticalIcon />}>Click me</Button>
 * ```
 *
...
export const SymmetryVerticalIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SymmetryVerticalIcon.displayName = 'SymmetryVerticalIcon';

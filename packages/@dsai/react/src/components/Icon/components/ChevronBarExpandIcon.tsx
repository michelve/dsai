 ...
 *
 * Bootstrap Icons - Chevron bar expand
 * @category Chevrons
 * @tags chevron
 * @see https://icons.getbootstrap.com/icons/chevron-bar-expand/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ChevronBarExpandIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ChevronBarExpandIcon aria-label="Chevron bar expand" />
 * ```
 */
...
export const ChevronBarExpandIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ChevronBarExpandIcon.displayName = 'ChevronBarExpandIcon';

 ...
 * CloudMinusFillIcon
 *
 * Bootstrap Icons - Cloud minus fill
 * @category Clouds
 * @tags subtract
 * @see https://icons.getbootstrap.com/icons/cloud-minus-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudMinusFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudMinusFillIcon aria-label="Cloud minus fill" />
 * ```
 */
...
export const CloudMinusFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudMinusFillIcon.displayName = 'CloudMinusFillIcon';

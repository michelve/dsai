 ...
 * PostcardFillIcon
 *
 * Bootstrap Icons - Postcard fill
 * @category Real world
 * @tags mail
 * @see https://icons.getbootstrap.com/icons/postcard-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PostcardFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PostcardFillIcon aria-label="Postcard fill" />
 * ```
 */
...
export const PostcardFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PostcardFillIcon.displayName = 'PostcardFillIcon';

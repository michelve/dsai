 ...
 * ```tsx
 * <Button startIcon={<BlockquoteRightIcon />}>Click me</Button>
 * ```
 *
...
export const BlockquoteRightIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BlockquoteRightIcon.displayName = 'BlockquoteRightIcon';

 ...
 *
 * Bootstrap Icons - File earmark binary fill
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-earmark-binary-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkBinaryFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileEarmarkBinaryFillIcon aria-label="File earmark binary fill" />
 * ```
 */
...
export const FileEarmarkBinaryFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkBinaryFillIcon.displayName = 'FileEarmarkBinaryFillIcon';

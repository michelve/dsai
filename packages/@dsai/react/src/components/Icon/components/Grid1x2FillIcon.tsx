 ...
 * ```tsx
 * <Button startIcon={<Grid1x2FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Grid1x2FillIcon aria-label="Grid1x2Fill" />
 * ```
 */
...
export const Grid1x2FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Grid1x2FillIcon.displayName = 'Grid1x2FillIcon';

 ...
 * ```tsx
 * <Button startIcon={<SkipForwardBtnIcon />}>Click me</Button>
 * ```
 *
...
export const SkipForwardBtnIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SkipForwardBtnIcon.displayName = 'SkipForwardBtnIcon';

 ...
 * ```tsx
 * <Button startIcon={<ListColumnsReverseIcon />}>Click me</Button>
 * ```
 *
...
export const ListColumnsReverseIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ListColumnsReverseIcon.displayName = 'ListColumnsReverseIcon';

 ...
 * StickiesFillIcon
 *
 * Bootstrap Icons - Stickies fill
 * @category Real world
 * @tags postit
 * @see https://icons.getbootstrap.com/icons/stickies-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<StickiesFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <StickiesFillIcon aria-label="Stickies fill" />
 * ```
 */
...
export const StickiesFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
StickiesFillIcon.displayName = 'StickiesFillIcon';

 ...
 * Icon8SquareIcon
 *
 * Bootstrap Icons - 8 square
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/8-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon8SquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon8SquareIcon aria-label="8 square" />
 * ```
 */
...
export const Icon8SquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon8SquareIcon.displayName = 'Icon8SquareIcon';

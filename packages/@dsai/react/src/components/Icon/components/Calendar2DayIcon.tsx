 ...
 * Calendar2DayIcon
 *
 * Bootstrap Icons - Calendar2 day
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar2-day/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Calendar2DayIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Calendar2DayIcon aria-label="Calendar2 day" />
 * ```
 */
...
export const Calendar2DayIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Calendar2DayIcon.displayName = 'Calendar2DayIcon';

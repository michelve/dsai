 ...
 * TypeH4Icon
 *
 * Bootstrap Icons - Type h4
 * @category Typography
 * @tags text
 * @see https://icons.getbootstrap.com/icons/type-h4/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TypeH4Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TypeH4Icon aria-label="Type h4" />
 * ```
 */
...
export const TypeH4Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TypeH4Icon.displayName = 'TypeH4Icon';

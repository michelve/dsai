 ...
 * ```tsx
 * <Button startIcon={<PersonVideo2Icon />}>Click me</Button>
 * ```
 *
...
export const PersonVideo2Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonVideo2Icon.displayName = 'PersonVideo2Icon';

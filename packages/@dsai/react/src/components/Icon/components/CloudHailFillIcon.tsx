 ...
 * ```tsx
 * <Button startIcon={<CloudHailFillIcon />}>Click me</Button>
 * ```
 *
...
export const CloudHailFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudHailFillIcon.displayName = 'CloudHailFillIcon';

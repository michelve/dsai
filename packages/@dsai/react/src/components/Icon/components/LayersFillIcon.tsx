 ...
 * LayersFillIcon
 *
 * Bootstrap Icons - Layers fill
 * @category Graphics
 * @tags perspective
 * @see https://icons.getbootstrap.com/icons/layers-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<LayersFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <LayersFillIcon aria-label="Layers fill" />
 * ```
 */
...
export const LayersFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
LayersFillIcon.displayName = 'LayersFillIcon';

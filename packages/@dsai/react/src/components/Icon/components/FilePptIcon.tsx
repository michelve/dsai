 ...
 * FilePptIcon
 *
 * Bootstrap Icons - File ppt
 * @category Files and folders
 * @tags slides
 * @see https://icons.getbootstrap.com/icons/file-ppt/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FilePptIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FilePptIcon aria-label="File ppt" />
 * ```
 */
...
export const FilePptIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

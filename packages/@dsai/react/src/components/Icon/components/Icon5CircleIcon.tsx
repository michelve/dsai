 ...
 * Icon5CircleIcon
 *
 * Bootstrap Icons - 5 circle
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/5-circle/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon5CircleIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon5CircleIcon aria-label="5 circle" />
 * ```
 */
...
export const Icon5CircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon5CircleIcon.displayName = 'Icon5CircleIcon';

 ...
 * ```tsx
 * <Button startIcon={<EmojiAstonishedFillIcon />}>Click me</Button>
 * ```
 *
...
export const EmojiAstonishedFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EmojiAstonishedFillIcon.displayName = 'EmojiAstonishedFillIcon';

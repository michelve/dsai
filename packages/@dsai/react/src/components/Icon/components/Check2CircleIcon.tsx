 ...
 * ```tsx
 * <Button startIcon={<Check2CircleIcon />}>Click me</Button>
 * ```
 *
...
export const Check2CircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Check2CircleIcon.displayName = 'Check2CircleIcon';

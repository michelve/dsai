 ...
 * ```tsx
 * <Button startIcon={<SunsetFillIcon />}>Click me</Button>
 * ```
 *
...
export const SunsetFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SunsetFillIcon.displayName = 'SunsetFillIcon';

 ...
 * DatabaseLockIcon
 *
 * Bootstrap Icons - Database lock
 * @category Devices
 * @tags server
 * @see https://icons.getbootstrap.com/icons/database-lock/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DatabaseLockIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DatabaseLockIcon aria-label="Database lock" />
 * ```
 */
...
export const DatabaseLockIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

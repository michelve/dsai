 ...
 * ```tsx
 * <Button startIcon={<WindowDashIcon />}>Click me</Button>
 * ```
 *
...
export const WindowDashIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
WindowDashIcon.displayName = 'WindowDashIcon';

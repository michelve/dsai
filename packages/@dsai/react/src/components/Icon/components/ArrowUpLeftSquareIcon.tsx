 ...
 *
 * Bootstrap Icons - Arrow up left square
 * @category Shape arrows
 * @tags arrow
 * @see https://icons.getbootstrap.com/icons/arrow-up-left-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ArrowUpLeftSquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ArrowUpLeftSquareIcon aria-label="Arrow up left square" />
 * ```
 */
...
export const ArrowUpLeftSquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowUpLeftSquareIcon.displayName = 'ArrowUpLeftSquareIcon';

 ...
 * ```tsx
 * <Button startIcon={<TruckFlatbedIcon />}>Click me</Button>
 * ```
 *
...
export const TruckFlatbedIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TruckFlatbedIcon.displayName = 'TruckFlatbedIcon';

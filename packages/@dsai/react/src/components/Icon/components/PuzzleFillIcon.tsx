 ...
 * ```tsx
 * <Button startIcon={<PuzzleFillIcon />}>Click me</Button>
 * ```
 *
...
export const PuzzleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PuzzleFillIcon.displayName = 'PuzzleFillIcon';

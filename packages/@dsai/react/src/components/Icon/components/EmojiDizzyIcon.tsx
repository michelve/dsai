 ...
 * ```tsx
 * <Button startIcon={<EmojiDizzyIcon />}>Click me</Button>
 * ```
 *
...
export const EmojiDizzyIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EmojiDizzyIcon.displayName = 'EmojiDizzyIcon';

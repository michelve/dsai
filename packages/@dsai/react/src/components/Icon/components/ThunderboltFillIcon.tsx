 ...
 * ```tsx
 * <Button startIcon={<ThunderboltFillIcon />}>Click me</Button>
 * ```
 *
...
export const ThunderboltFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ThunderboltFillIcon.displayName = 'ThunderboltFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<BadgeVoFillIcon />}>Click me</Button>
 * ```
 *
...
export const BadgeVoFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BadgeVoFillIcon.displayName = 'BadgeVoFillIcon';

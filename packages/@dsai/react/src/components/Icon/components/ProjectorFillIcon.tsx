 ...
 * ```tsx
 * <Button startIcon={<ProjectorFillIcon />}>Click me</Button>
 * ```
 *
...
export const ProjectorFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ProjectorFillIcon.displayName = 'ProjectorFillIcon';

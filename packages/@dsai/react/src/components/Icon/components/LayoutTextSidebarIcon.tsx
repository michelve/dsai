 ...
 *
 * Bootstrap Icons - Layout text sidebar
 * @category Layout
 * @tags layout
 * @see https://icons.getbootstrap.com/icons/layout-text-sidebar/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<LayoutTextSidebarIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <LayoutTextSidebarIcon aria-label="Layout text sidebar" />
 * ```
 */
...
export const LayoutTextSidebarIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
LayoutTextSidebarIcon.displayName = 'LayoutTextSidebarIcon';

 ...
 * Icon0SquareIcon
 *
 * Bootstrap Icons - 0 square
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/0-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon0SquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon0SquareIcon aria-label="0 square" />
 * ```
 */
...
export const Icon0SquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon0SquareIcon.displayName = 'Icon0SquareIcon';

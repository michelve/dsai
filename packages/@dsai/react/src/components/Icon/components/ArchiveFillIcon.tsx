 ...
 * ```tsx
 * <Button startIcon={<ArchiveFillIcon />}>Click me</Button>
 * ```
 *
...
export const ArchiveFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArchiveFillIcon.displayName = 'ArchiveFillIcon';

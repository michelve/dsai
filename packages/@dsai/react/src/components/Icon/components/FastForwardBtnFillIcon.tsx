 ...
 * ```tsx
 * <Button startIcon={<FastForwardBtnFillIcon />}>Click me</Button>
 * ```
 *
...
export const FastForwardBtnFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FastForwardBtnFillIcon.displayName = 'FastForwardBtnFillIcon';

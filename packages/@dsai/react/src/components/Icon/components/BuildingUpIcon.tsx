 ...
 * ```tsx
 * <Button startIcon={<BuildingUpIcon />}>Click me</Button>
 * ```
 *
...
export const BuildingUpIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BuildingUpIcon.displayName = 'BuildingUpIcon';

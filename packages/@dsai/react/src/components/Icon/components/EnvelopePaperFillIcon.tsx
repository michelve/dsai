 ...
 *
 * Bootstrap Icons - Envelope paper fill
 * @category Communications
 * @tags email
 * @see https://icons.getbootstrap.com/icons/envelope-paper-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EnvelopePaperFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EnvelopePaperFillIcon aria-label="Envelope paper fill" />
 * ```
 */
...
export const EnvelopePaperFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EnvelopePaperFillIcon.displayName = 'EnvelopePaperFillIcon';

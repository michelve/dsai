 ...
 *
 * Bootstrap Icons - Distribute vertical
 * @category Graphics
 * @tags space
 * @see https://icons.getbootstrap.com/icons/distribute-vertical/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DistributeVerticalIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DistributeVerticalIcon aria-label="Distribute vertical" />
 * ```
 */
...
export const DistributeVerticalIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

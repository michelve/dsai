 ...
 * @category Typography
 * @tags divider
 * @see https://icons.getbootstrap.com/icons/vr/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<VrIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <VrIcon aria-label="VR" />
 * ```
 */
...
export const VrIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

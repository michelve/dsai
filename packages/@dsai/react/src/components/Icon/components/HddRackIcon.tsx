 ...
 * HddRackIcon
 *
 * Bootstrap Icons - Hdd rack
 * @category Devices
 * @tags "hard drive"
 * @see https://icons.getbootstrap.com/icons/hdd-rack/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HddRackIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HddRackIcon aria-label="Hdd rack" />
 * ```
 */
...
export const HddRackIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HddRackIcon.displayName = 'HddRackIcon';

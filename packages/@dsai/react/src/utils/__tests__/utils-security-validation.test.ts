 ...
 *
 * Tests security-focused utilities and input validation:
 * - Safe href validation (isSafeHref, isValidHref)
 * - XSS protection and protocol blocking
 * - Safe input attribute filtering (getSafeInputProps)
 * - Selection event helpers (selectAllEvent, toggleAllEvent)
 *
 * These utilities protect against common security vulnerabilities:

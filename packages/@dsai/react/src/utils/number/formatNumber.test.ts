...
describe('formatNumber', () => {
  ...
  describe('Compact notation', () => {
    ...
    it('should format billions with compact notation', () => {
      const result = formatNumber(3000000000, {
        notation: 'compact',
      });
  ...
  describe('Caching', () => {
    it('should cache formatters', () => {
      ...
      formatNumber(9999.99); // Same options, should reuse
      expect(formatNumber.getCacheSize()).toBe(1);
    });
...
describe('formatCurrency', () => {
  ...
  describe('Basic functionality', () => {
    ...
    it('should format with KRW currency (no decimals)', () => {
      const result = formatCurrency(1234, { currency: 'KRW' });
  ...
  describe('Caching', () => {
    it('should cache formatters', () => {
      ...
      formatCurrency(9999.99); // Same options, should reuse
      expect(formatCurrency.getCacheSize()).toBe(1);
    });
    ...
    it('should create new formatters for different locales', () => {
      ...
      formatCurrency(1234.56, { locale: 'de-DE', currency: 'USD' });
      expect(formatCurrency.getCacheSize()).toBe(2);
    });
  ...
  describe('Edge cases', () => {
    ...
    it('should handle very large amounts', () => {
      const result = formatCurrency(999999999999.99, { currency: 'USD' });
      expect(typeof result).toBe('string');
      expect(result).toMatch(/\$/);
    });

...
const styles = {
  ...
  gap: tokens.spacing['2'],
      ...
      <ul>
        <li>
          <strong>Use spacing scale consistently:</strong> Stick to the defined tokens for predictable layouts
        </li>
        <li>
          <strong>Smaller gaps for related content:</strong> Use spacing-1 or spacing-2 within components
        </li>
        <li>
          <strong>Larger gaps for sections:</strong> Use spacing-5 to spacing-8 between major sections
        </li>
        <li>

...
}`,...(m=(x=s.parameters)==null?void 0:x.docs)==null?void 0:m.source},description:{story:"Font Families",...(u=(f=s.parameters)==null?void 0:f.docs)==null?void 0:u.description}}};var v,z,b,S,j;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => {
    const sizes = [{
      name: 'Extra Small',
      token: 'xs',
...
}`,...(b=(z=a.parameters)==null?void 0:z.docs)==null?void 0:b.source},description:{story:"Font Sizes",...(j=(S=a.parameters)==null?void 0:S.docs)==null?void 0:j.description}}};var k,w,T,F,W;r.parameters={...r.parameters,docs:{...(k=r.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => {
    const displays = [{
      name: 'Display 1',
      token: 'display1',
...
}`,...(T=(w=r.parameters)==null?void 0:w.docs)==null?void 0:T.source},description:{story:"Display Typography - Large, attention-grabbing text for hero sections",...(W=(F=r.parameters)==null?void 0:F.docs)==null?void 0:W.description}}};var L,D,H,U,C;l.parameters={...l.parameters,docs:{...(L=l.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => {
    const headings = [{
      tag: 'h1',
      size: '48px',
...
}`,...(I=(B=p.parameters)==null?void 0:B.docs)==null?void 0:I.source},description:{story:"Font Weights",...(E=(R=p.parameters)==null?void 0:R.docs)==null?void 0:E.description}}};var M,A,P,_,O;d.parameters={...d.parameters,docs:{...(M=d.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => {
    const lineHeights = [{
      name: 'Tight',
      value: '1.25',
...
}`,...(P=(A=d.parameters)==null?void 0:A.docs)==null?void 0:P.source},description:{story:"Line Heights",...(O=(_=d.parameters)==null?void 0:_.docs)==null?void 0:O.description}}};var X,J,G,K,N;c.parameters={...c.parameters,docs:{...(X=c.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => <div style={{
    maxWidth: '800px'
  }}>
...
}`,...(G=(J=c.parameters)==null?void 0:J.docs)==null?void 0:G.source},description:{story:"Usage Examples",...(N=(K=c.parameters)==null?void 0:K.docs)==null?void 0:N.description}}};const Y=["FontFamilies","FontSizes","DisplayTypography","Headings","FontWeights","LineHeights","Usage"],ee=Object.freeze(Object.defineProperty({__proto__:null,DisplayTypography:r,FontFamilies:s,FontSizes:a,FontWeights:p,Headings:l,LineHeights:d,Usage:c,__namedExportsOrder:Y,default:Q},Symbol.toStringTag,{value:"Module"}));export{ee as T};

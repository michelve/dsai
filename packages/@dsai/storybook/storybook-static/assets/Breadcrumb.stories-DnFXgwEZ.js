...
and converted to safe '#' fallback`,...(ke=(Ce=h.parameters)==null?void 0:Ce.docs)==null?void 0:ke.description}}};var Be,Ne,Ie,Se,Pe;x.parameters={...x.parameters,docs:{...(Be=x.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  render: () => <div>
      ...
      <div className="alert alert-info mt-3 mb-0">
        <small>
          <strong>Security:</strong> All external links include rel="noopener noreferrer" to prevent:
  ...
  render: () => <div>
      ...
      <div className="alert alert-info mt-3 mb-0">
        <small>
          <strong>Accessibility:</strong> Screen readers announce only text labels, not icons.
          Icons enhance visual hierarchy without affecting assistive technology.
        </small>
      </div>
    </div>
  ...
  render: function PerformanceBreadcrumb() {
    ...
    return <div>
        ...
        <div className="alert alert-info mt-3 mb-0">
          <small>
            <strong>Performance:</strong> The breadcrumb component uses React.memo and useMemo hooks to:
            <ul className="mb-0 mt-1">

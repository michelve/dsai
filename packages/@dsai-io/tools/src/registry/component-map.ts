...
export const componentMap: Record<string, ComponentMeta> = {
  ...
  card: {
    ...
    categories: [CAT_LAYOUT, CAT_DATA_DISPLAY],
  },
  'card-list': {
    type: TYPE_UI,
    title: 'CardList',
  ...
  dropdown: {
    ...
    categories: [CAT_NAVIGATION, CAT_ACTIONS],
  ...
  'list-group': {
    ...
    categories: [CAT_DATA_DISPLAY, CAT_NAVIGATION],
  },
  modal: {
    type: TYPE_UI,
    title: 'Modal',
  ...
  'selectable-card': {
    ...
    categories: [CAT_FORMS, CAT_DATA_DISPLAY],
  },
  sheet: {
    type: TYPE_UI,
    title: 'Sheet',

 ...
 * RewindBtnFillIcon
 *
 * Bootstrap Icons - Rewind btn fill
 * @category Media
 * @tags audio
 * @see https://icons.getbootstrap.com/icons/rewind-btn-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<RewindBtnFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <RewindBtnFillIcon aria-label="Rewind btn fill" />
 * ```
 */
...
export const RewindBtnFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
RewindBtnFillIcon.displayName = 'RewindBtnFillIcon';

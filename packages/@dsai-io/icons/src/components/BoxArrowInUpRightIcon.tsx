 ...
 *
 * Bootstrap Icons - Box arrow in up right
 * @category Box arrows
 * @tags arrow
 * @see https://icons.getbootstrap.com/icons/box-arrow-in-up-right/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BoxArrowInUpRightIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BoxArrowInUpRightIcon aria-label="Box arrow in up right" />
 * ```
 */
...
export const BoxArrowInUpRightIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BoxArrowInUpRightIcon.displayName = 'BoxArrowInUpRightIcon';

 ...
 * ```tsx
 * <Button startIcon={<UsbMicroFillIcon />}>Click me</Button>
 * ```
 *
...
export const UsbMicroFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
UsbMicroFillIcon.displayName = 'UsbMicroFillIcon';

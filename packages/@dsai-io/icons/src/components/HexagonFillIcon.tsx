 ...
 * HexagonFillIcon
 *
 * Bootstrap Icons - Hexagon fill
 * @category Shapes
 * @tags shape
 * @see https://icons.getbootstrap.com/icons/hexagon-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HexagonFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HexagonFillIcon aria-label="Hexagon fill" />
 * ```
 */
...
export const HexagonFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

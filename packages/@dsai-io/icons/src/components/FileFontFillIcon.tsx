 ...
 * FileFontFillIcon
 *
 * Bootstrap Icons - File font fill
 * @category Files and folders
 * @tags ttf
 * @see https://icons.getbootstrap.com/icons/file-font-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileFontFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileFontFillIcon aria-label="File font fill" />
 * ```
 */
...
export const FileFontFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileFontFillIcon.displayName = 'FileFontFillIcon';

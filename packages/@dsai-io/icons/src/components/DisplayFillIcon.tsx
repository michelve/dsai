 ...
 * DisplayFillIcon
 *
 * Bootstrap Icons - Display fill
 * @category Devices
 * @tags monitor
 * @see https://icons.getbootstrap.com/icons/display-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DisplayFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DisplayFillIcon aria-label="Display fill" />
 * ```
 */
...
export const DisplayFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DisplayFillIcon.displayName = 'DisplayFillIcon';

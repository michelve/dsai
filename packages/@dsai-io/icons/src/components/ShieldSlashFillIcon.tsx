 ...
 * ShieldSlashFillIcon
 *
 * Bootstrap Icons - Shield slash fill
 * @category Security
 * @tags shield
 * @see https://icons.getbootstrap.com/icons/shield-slash-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ShieldSlashFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ShieldSlashFillIcon aria-label="Shield slash fill" />
 * ```
 */
...
export const ShieldSlashFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
ShieldSlashFillIcon.displayName = 'ShieldSlashFillIcon';

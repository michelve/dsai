 ...
 * BoomboxFillIcon
 *
 * Bootstrap Icons - Boombox fill
 * @category Real world
 * @tags music
 * @see https://icons.getbootstrap.com/icons/boombox-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BoomboxFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BoomboxFillIcon aria-label="Boombox fill" />
 * ```
 */
...
export const BoomboxFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BoomboxFillIcon.displayName = 'BoomboxFillIcon';

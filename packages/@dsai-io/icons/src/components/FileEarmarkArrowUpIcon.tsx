 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkArrowUpIcon />}>Click me</Button>
 * ```
 *
...
export const FileEarmarkArrowUpIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkArrowUpIcon.displayName = 'FileEarmarkArrowUpIcon';

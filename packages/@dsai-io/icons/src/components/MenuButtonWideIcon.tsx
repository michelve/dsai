 ...
 * ```tsx
 * <Button startIcon={<MenuButtonWideIcon />}>Click me</Button>
 * ```
 *
...
export const MenuButtonWideIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
MenuButtonWideIcon.displayName = 'MenuButtonWideIcon';

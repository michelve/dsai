 ...
 * CalendarDayFillIcon
 *
 * Bootstrap Icons - Calendar day fill
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar-day-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CalendarDayFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CalendarDayFillIcon aria-label="Calendar day fill" />
 * ```
 */
...
export const CalendarDayFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CalendarDayFillIcon.displayName = 'CalendarDayFillIcon';

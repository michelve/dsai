 ...
 * Icon5SquareFillIcon
 *
 * Bootstrap Icons - 5 square fill
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/5-square-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon5SquareFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon5SquareFillIcon aria-label="5 square fill" />
 * ```
 */
...
export const Icon5SquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon5SquareFillIcon.displayName = 'Icon5SquareFillIcon';

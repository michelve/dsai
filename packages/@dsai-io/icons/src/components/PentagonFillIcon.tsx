 ...
 * ```tsx
 * <Button startIcon={<PentagonFillIcon />}>Click me</Button>
 * ```
 *
...
export const PentagonFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PentagonFillIcon.displayName = 'PentagonFillIcon';

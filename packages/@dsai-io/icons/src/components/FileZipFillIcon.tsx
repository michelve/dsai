 ...
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-zip-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileZipFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileZipFillIcon aria-label="File zip fill" />
 * ```
 */
...
export const FileZipFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FileZipFillIcon.displayName = 'FileZipFillIcon';

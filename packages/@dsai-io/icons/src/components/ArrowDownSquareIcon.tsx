 ...
 * ArrowDownSquareIcon
 *
 * Bootstrap Icons - Arrow down square
 * @category Shape arrows
 * @tags arrow
 * @see https://icons.getbootstrap.com/icons/arrow-down-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ArrowDownSquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ArrowDownSquareIcon aria-label="Arrow down square" />
 * ```
 */
...
export const ArrowDownSquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

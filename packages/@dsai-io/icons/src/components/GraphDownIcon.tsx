 ...
 * GraphDownIcon
 *
 * Bootstrap Icons - Graph down
 * @category Data
 * @tags chart
 * @see https://icons.getbootstrap.com/icons/graph-down/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<GraphDownIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <GraphDownIcon aria-label="Graph down" />
 * ```
 */
...
export const GraphDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
GraphDownIcon.displayName = 'GraphDownIcon';

 ...
 * BadgeVrIcon
 *
 * Bootstrap Icons - Badge vr
 * @category Badges
 * @tags virtual
 * @see https://icons.getbootstrap.com/icons/badge-vr/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BadgeVrIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BadgeVrIcon aria-label="Badge vr" />
 * ```
 */
...
export const BadgeVrIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

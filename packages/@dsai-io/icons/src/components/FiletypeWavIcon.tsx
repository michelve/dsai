 ...
 * FiletypeWavIcon
 *
 * Bootstrap Icons - Filetype wav
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-wav/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeWavIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeWavIcon aria-label="Filetype wav" />
 * ```
 */
...
export const FiletypeWavIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FiletypeWavIcon.displayName = 'FiletypeWavIcon';

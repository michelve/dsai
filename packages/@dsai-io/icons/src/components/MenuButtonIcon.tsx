 ...
 * ```tsx
 * <Button startIcon={<MenuButtonIcon />}>Click me</Button>
 * ```
 *
...
export const MenuButtonIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
MenuButtonIcon.displayName = 'MenuButtonIcon';

 ...
 * ```tsx
 * <Button startIcon={<ArrowsFullscreenIcon />}>Click me</Button>
 * ```
 *
...
export const ArrowsFullscreenIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowsFullscreenIcon.displayName = 'ArrowsFullscreenIcon';

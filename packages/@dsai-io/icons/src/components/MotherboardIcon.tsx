 ...
 * ```tsx
 * <Button startIcon={<MotherboardIcon />}>Click me</Button>
 * ```
 *
...
export const MotherboardIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
MotherboardIcon.displayName = 'MotherboardIcon';

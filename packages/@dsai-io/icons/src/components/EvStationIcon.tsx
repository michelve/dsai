 ...
 * EvStationIcon
 *
 * Bootstrap Icons - EV station
 * @category Transportation
 * @tags charging
 * @see https://icons.getbootstrap.com/icons/ev-station/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EvStationIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EvStationIcon aria-label="EV station" />
 * ```
 */
...
export const EvStationIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

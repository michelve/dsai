 ...
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-word/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileWordIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileWordIcon aria-label="File word" />
 * ```
 */
...
export const FileWordIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

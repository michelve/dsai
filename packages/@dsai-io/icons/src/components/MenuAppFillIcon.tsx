 ...
 * MenuAppFillIcon
 *
 * Bootstrap Icons - Menu app fill
 * @category Controls
 * @tags dropdown
 * @see https://icons.getbootstrap.com/icons/menu-app-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<MenuAppFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <MenuAppFillIcon aria-label="Menu app fill" />
 * ```
 */
...
export const MenuAppFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
MenuAppFillIcon.displayName = 'MenuAppFillIcon';

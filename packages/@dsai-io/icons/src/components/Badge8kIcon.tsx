 ...
 * ```tsx
 * <Button startIcon={<Badge8kIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Badge8kIcon aria-label="Badge8k" />
 * ```
 */
...
export const Badge8kIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

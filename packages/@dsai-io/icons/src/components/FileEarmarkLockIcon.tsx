 ...
 * FileEarmarkLockIcon
 *
 * Bootstrap Icons - File earmark lock
 * @category Files and folders
 * @tags lock
 * @see https://icons.getbootstrap.com/icons/file-earmark-lock/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkLockIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileEarmarkLockIcon aria-label="File earmark lock" />
 * ```
 */
...
export const FileEarmarkLockIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkLockIcon.displayName = 'FileEarmarkLockIcon';

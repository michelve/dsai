 ...
 * ```tsx
 * <Button startIcon={<PersonRolodexIcon />}>Click me</Button>
 * ```
 *
...
export const PersonRolodexIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonRolodexIcon.displayName = 'PersonRolodexIcon';

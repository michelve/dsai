 ...
 * Cake2Icon
 *
 * Bootstrap Icons - Cake2
 * @category Real world
 * @tags birthday
 * @see https://icons.getbootstrap.com/icons/cake2/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Cake2Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Cake2Icon aria-label="Cake2" />
 * ```
 */
...
export const Cake2Icon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
Cake2Icon.displayName = 'Cake2Icon';

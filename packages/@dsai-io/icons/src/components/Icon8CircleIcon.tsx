 ...
 * ```tsx
 * <Button startIcon={<Icon8CircleIcon />}>Click me</Button>
 * ```
 *
...
export const Icon8CircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
Icon8CircleIcon.displayName = 'Icon8CircleIcon';

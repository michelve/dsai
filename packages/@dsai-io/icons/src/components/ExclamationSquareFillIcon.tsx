 ...
 * ```tsx
 * <Button startIcon={<ExclamationSquareFillIcon />}>Click me</Button>
 * ```
 *
...
export const ExclamationSquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
ExclamationSquareFillIcon.displayName = 'ExclamationSquareFillIcon';

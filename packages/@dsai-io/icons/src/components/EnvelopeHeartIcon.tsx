 ...
 * EnvelopeHeartIcon
 *
 * Bootstrap Icons - Envelope heart
 * @category Communications
 * @tags email
 * @see https://icons.getbootstrap.com/icons/envelope-heart/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EnvelopeHeartIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EnvelopeHeartIcon aria-label="Envelope heart" />
 * ```
 */
...
export const EnvelopeHeartIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EnvelopeHeartIcon.displayName = 'EnvelopeHeartIcon';

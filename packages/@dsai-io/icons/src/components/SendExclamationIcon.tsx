 ...
 * ```tsx
 * <Button startIcon={<SendExclamationIcon />}>Click me</Button>
 * ```
 *
...
export const SendExclamationIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SendExclamationIcon.displayName = 'SendExclamationIcon';

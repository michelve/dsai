 ...
 * HouseUpFillIcon
 *
 * Bootstrap Icons - House up fill
 * @category Real world
 * @tags home
 * @see https://icons.getbootstrap.com/icons/house-up-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HouseUpFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HouseUpFillIcon aria-label="House up fill" />
 * ```
 */
...
export const HouseUpFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HouseUpFillIcon.displayName = 'HouseUpFillIcon';

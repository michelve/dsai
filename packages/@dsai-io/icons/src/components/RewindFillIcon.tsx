 ...
 * RewindFillIcon
 *
 * Bootstrap Icons - Rewind fill
 * @category Media
 * @tags audio
 * @see https://icons.getbootstrap.com/icons/rewind-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<RewindFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <RewindFillIcon aria-label="Rewind fill" />
 * ```
 */
...
export const RewindFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
RewindFillIcon.displayName = 'RewindFillIcon';

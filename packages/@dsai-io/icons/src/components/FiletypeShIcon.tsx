 ...
 * ```tsx
 * <Button startIcon={<FiletypeShIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypeShIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FiletypeShIcon.displayName = 'FiletypeShIcon';

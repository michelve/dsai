 ...
 *
 * Bootstrap Icons - Emoji sunglasses fill
 * @category Emoji
 * @tags emoticon
 * @see https://icons.getbootstrap.com/icons/emoji-sunglasses-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EmojiSunglassesFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EmojiSunglassesFillIcon aria-label="Emoji sunglasses fill" />
 * ```
 */
...
export const EmojiSunglassesFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EmojiSunglassesFillIcon.displayName = 'EmojiSunglassesFillIcon';

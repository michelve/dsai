 ...
 * ```tsx
 * <Button startIcon={<EnvelopeOpenHeartFillIcon />}>Click me</Button>
 * ```
 *
...
export const EnvelopeOpenHeartFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
EnvelopeOpenHeartFillIcon.displayName = 'EnvelopeOpenHeartFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<SimSlashFillIcon />}>Click me</Button>
 * ```
 *
...
export const SimSlashFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SimSlashFillIcon.displayName = 'SimSlashFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<ChatSquareTextFillIcon />}>Click me</Button>
 * ```
 *
...
export const ChatSquareTextFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ChatSquareTextFillIcon.displayName = 'ChatSquareTextFillIcon';

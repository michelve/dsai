 ...
 * FilterSquareIcon
 *
 * Bootstrap Icons - Filter square
 * @category Sort and filter
 * @tags sort
 * @see https://icons.getbootstrap.com/icons/filter-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FilterSquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FilterSquareIcon aria-label="Filter square" />
 * ```
 */
...
export const FilterSquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FilterSquareIcon.displayName = 'FilterSquareIcon';

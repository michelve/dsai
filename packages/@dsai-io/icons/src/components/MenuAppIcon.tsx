 ...
 * MenuAppIcon
 *
 * Bootstrap Icons - Menu app
 * @category Controls
 * @tags dropdown
 * @see https://icons.getbootstrap.com/icons/menu-app/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<MenuAppIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <MenuAppIcon aria-label="Menu app" />
 * ```
 */
...
export const MenuAppIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
MenuAppIcon.displayName = 'MenuAppIcon';

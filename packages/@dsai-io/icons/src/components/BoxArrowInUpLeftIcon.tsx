 ...
 *
 * Bootstrap Icons - Box arrow in up left
 * @category Box arrows
 * @tags arrow
 * @see https://icons.getbootstrap.com/icons/box-arrow-in-up-left/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BoxArrowInUpLeftIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BoxArrowInUpLeftIcon aria-label="Box arrow in up left" />
 * ```
 */
...
export const BoxArrowInUpLeftIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BoxArrowInUpLeftIcon.displayName = 'BoxArrowInUpLeftIcon';

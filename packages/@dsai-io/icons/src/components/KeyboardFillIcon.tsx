 ...
 * ```tsx
 * <Button startIcon={<KeyboardFillIcon />}>Click me</Button>
 * ```
 *
...
export const KeyboardFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
KeyboardFillIcon.displayName = 'KeyboardFillIcon';

 ...
 * Calendar2FillIcon
 *
 * Bootstrap Icons - Calendar2 fill
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar2-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Calendar2FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Calendar2FillIcon aria-label="Calendar2 fill" />
 * ```
 */
...
export const Calendar2FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Calendar2FillIcon.displayName = 'Calendar2FillIcon';

 ...
 *
 * Bootstrap Icons - Envelope open heart
 * @category Communications
 * @tags email
 * @see https://icons.getbootstrap.com/icons/envelope-open-heart/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EnvelopeOpenHeartIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EnvelopeOpenHeartIcon aria-label="Envelope open heart" />
 * ```
 */
...
export const EnvelopeOpenHeartIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
EnvelopeOpenHeartIcon.displayName = 'EnvelopeOpenHeartIcon';

 ...
 * ```tsx
 * <Button startIcon={<BuildingFillGearIcon />}>Click me</Button>
 * ```
 *
...
export const BuildingFillGearIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BuildingFillGearIcon.displayName = 'BuildingFillGearIcon';

 ...
 * HddStackFillIcon
 *
 * Bootstrap Icons - Hdd stack fill
 * @category Devices
 * @tags "hard drive"
 * @see https://icons.getbootstrap.com/icons/hdd-stack-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HddStackFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HddStackFillIcon aria-label="Hdd stack fill" />
 * ```
 */
...
export const HddStackFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HddStackFillIcon.displayName = 'HddStackFillIcon';

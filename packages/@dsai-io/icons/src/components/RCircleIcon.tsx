 ...
 * RCircleIcon
 *
 * Bootstrap Icons - R circle
 * @category Shapes
 * @tags registered
 * @see https://icons.getbootstrap.com/icons/r-circle/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<RCircleIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <RCircleIcon aria-label="R circle" />
 * ```
 */
...
export const RCircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
RCircleIcon.displayName = 'RCircleIcon';

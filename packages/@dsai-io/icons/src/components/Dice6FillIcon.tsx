 ...
 * ```tsx
 * <Button startIcon={<Dice6FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Dice6FillIcon aria-label="Dice6Fill" />
 * ```
 */
...
export const Dice6FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Dice6FillIcon.displayName = 'Dice6FillIcon';

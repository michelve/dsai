 ...
 * ```tsx
 * <Button startIcon={<BorderCenterIcon />}>Click me</Button>
 * ```
 *
...
export const BorderCenterIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
BorderCenterIcon.displayName = 'BorderCenterIcon';

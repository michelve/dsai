 ...
 * LightbulbOffIcon
 *
 * Bootstrap Icons - Lightbulb off
 * @category Real world
 * @tags lights
 * @see https://icons.getbootstrap.com/icons/lightbulb-off/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<LightbulbOffIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <LightbulbOffIcon aria-label="Lightbulb off" />
 * ```
 */
...
export const LightbulbOffIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

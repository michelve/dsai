 ...
 * Backpack2Icon
 *
 * Bootstrap Icons - Backpack2
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/backpack2/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Backpack2Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Backpack2Icon aria-label="Backpack2" />
 * ```
 */
...
export const Backpack2Icon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

 ...
 * ```tsx
 * <Button startIcon={<SegmentedNavIcon />}>Click me</Button>
 * ```
 *
...
export const SegmentedNavIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SegmentedNavIcon.displayName = 'SegmentedNavIcon';

 ...
 * ```tsx
 * <Button startIcon={<PcDisplayHorizontalIcon />}>Click me</Button>
 * ```
 *
...
export const PcDisplayHorizontalIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PcDisplayHorizontalIcon.displayName = 'PcDisplayHorizontalIcon';

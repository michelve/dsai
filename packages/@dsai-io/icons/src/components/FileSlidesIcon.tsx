 ...
 * FileSlidesIcon
 *
 * Bootstrap Icons - File slides
 * @category Files and folders
 * @tags presentation
 * @see https://icons.getbootstrap.com/icons/file-slides/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileSlidesIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileSlidesIcon aria-label="File slides" />
 * ```
 */
...
export const FileSlidesIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FileSlidesIcon.displayName = 'FileSlidesIcon';

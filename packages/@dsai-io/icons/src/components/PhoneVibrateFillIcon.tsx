 ...
 * ```tsx
 * <Button startIcon={<PhoneVibrateFillIcon />}>Click me</Button>
 * ```
 *
...
export const PhoneVibrateFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PhoneVibrateFillIcon.displayName = 'PhoneVibrateFillIcon';

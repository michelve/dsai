 ...
 * ```tsx
 * <Button startIcon={<CcCircleFillIcon />}>Click me</Button>
 * ```
 *
...
export const CcCircleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
CcCircleFillIcon.displayName = 'CcCircleFillIcon';

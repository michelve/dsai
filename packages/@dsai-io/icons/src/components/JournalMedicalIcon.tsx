 ...
 * JournalMedicalIcon
 *
 * Bootstrap Icons - Journal medical
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/journal-medical/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<JournalMedicalIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <JournalMedicalIcon aria-label="Journal medical" />
 * ```
 */
...
export const JournalMedicalIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
JournalMedicalIcon.displayName = 'JournalMedicalIcon';

 ...
 * EmojiGrinIcon
 *
 * Bootstrap Icons - Emoji grin
 * @category Emoji
 * @tags emoticon
 * @see https://icons.getbootstrap.com/icons/emoji-grin/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EmojiGrinIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EmojiGrinIcon aria-label="Emoji grin" />
 * ```
 */
...
export const EmojiGrinIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EmojiGrinIcon.displayName = 'EmojiGrinIcon';

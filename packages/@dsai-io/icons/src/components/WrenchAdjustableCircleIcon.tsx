 ...
 * ```tsx
 * <Button startIcon={<WrenchAdjustableCircleIcon />}>Click me</Button>
 * ```
 *
...
export const WrenchAdjustableCircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
WrenchAdjustableCircleIcon.displayName = 'WrenchAdjustableCircleIcon';

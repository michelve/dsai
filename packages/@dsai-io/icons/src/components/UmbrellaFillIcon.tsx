 ...
 * UmbrellaFillIcon
 *
 * Bootstrap Icons - Umbrella fill
 * @category Weather
 * @tags rain
 * @see https://icons.getbootstrap.com/icons/umbrella-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<UmbrellaFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <UmbrellaFillIcon aria-label="Umbrella fill" />
 * ```
 */
...
export const UmbrellaFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
UmbrellaFillIcon.displayName = 'UmbrellaFillIcon';

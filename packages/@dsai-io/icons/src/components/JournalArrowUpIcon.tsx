 ...
 * ```tsx
 * <Button startIcon={<JournalArrowUpIcon />}>Click me</Button>
 * ```
 *
...
export const JournalArrowUpIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
JournalArrowUpIcon.displayName = 'JournalArrowUpIcon';

 ...
 * ```tsx
 * <Button startIcon={<SkipBackwardCircleIcon />}>Click me</Button>
 * ```
 *
...
export const SkipBackwardCircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
SkipBackwardCircleIcon.displayName = 'SkipBackwardCircleIcon';

 ...
 * ```tsx
 * <Button startIcon={<DatabaseFillSlashIcon />}>Click me</Button>
 * ```
 *
...
export const DatabaseFillSlashIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DatabaseFillSlashIcon.displayName = 'DatabaseFillSlashIcon';

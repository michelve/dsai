 ...
 * JustifyRightIcon
 *
 * Bootstrap Icons - Justify right
 * @category Typography
 * @tags text
 * @see https://icons.getbootstrap.com/icons/justify-right/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<JustifyRightIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <JustifyRightIcon aria-label="Justify right" />
 * ```
 */
...
export const JustifyRightIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
JustifyRightIcon.displayName = 'JustifyRightIcon';

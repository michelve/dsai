 ...
 * ```tsx
 * <Button startIcon={<SignMergeRightIcon />}>Click me</Button>
 * ```
 *
...
export const SignMergeRightIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
SignMergeRightIcon.displayName = 'SignMergeRightIcon';

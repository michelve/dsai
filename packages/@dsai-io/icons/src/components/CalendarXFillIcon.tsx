 ...
 * CalendarXFillIcon
 *
 * Bootstrap Icons - Calendar x fill
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CalendarXFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CalendarXFillIcon aria-label="Calendar x fill" />
 * ```
 */
...
export const CalendarXFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CalendarXFillIcon.displayName = 'CalendarXFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<RocketFillIcon />}>Click me</Button>
 * ```
 *
...
export const RocketFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
RocketFillIcon.displayName = 'RocketFillIcon';

 ...
 * BehanceIcon
 *
 * Bootstrap Icons - Behance
 * @category Brand
 * @tags social
 * @see https://icons.getbootstrap.com/icons/behance/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BehanceIcon />}>Click me</Button>
 * ```
 *
...
export const BehanceIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

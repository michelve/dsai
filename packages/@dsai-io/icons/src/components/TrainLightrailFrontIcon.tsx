 ...
 * ```tsx
 * <Button startIcon={<TrainLightrailFrontIcon />}>Click me</Button>
 * ```
 *
...
export const TrainLightrailFrontIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
TrainLightrailFrontIcon.displayName = 'TrainLightrailFrontIcon';

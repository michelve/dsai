 ...
 * ```tsx
 * <Button startIcon={<CameraVideoFillIcon />}>Click me</Button>
 * ```
 *
...
export const CameraVideoFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CameraVideoFillIcon.displayName = 'CameraVideoFillIcon';

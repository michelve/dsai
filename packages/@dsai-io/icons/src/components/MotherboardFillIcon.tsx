 ...
 * ```tsx
 * <Button startIcon={<MotherboardFillIcon />}>Click me</Button>
 * ```
 *
...
export const MotherboardFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
MotherboardFillIcon.displayName = 'MotherboardFillIcon';

 ...
 * @category Devices
 * @tags port
 * @see https://icons.getbootstrap.com/icons/usb-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<UsbFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <UsbFillIcon aria-label="USB fill" />
 * ```
 */
...
export const UsbFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
UsbFillIcon.displayName = 'UsbFillIcon';

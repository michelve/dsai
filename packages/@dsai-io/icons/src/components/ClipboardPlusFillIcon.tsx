 ...
 *
 * Bootstrap Icons - Clipboard plus fill
 * @category Real world
 * @tags copy
 * @see https://icons.getbootstrap.com/icons/clipboard-plus-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ClipboardPlusFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ClipboardPlusFillIcon aria-label="Clipboard plus fill" />
 * ```
 */
...
export const ClipboardPlusFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ClipboardPlusFillIcon.displayName = 'ClipboardPlusFillIcon';

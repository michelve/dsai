 ...
 * ```tsx
 * <Button startIcon={<CloudHazeFillIcon />}>Click me</Button>
 * ```
 *
...
export const CloudHazeFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
CloudHazeFillIcon.displayName = 'CloudHazeFillIcon';

 ...
 * PlugFillIcon
 *
 * Bootstrap Icons - Plug fill
 * @category Real world
 * @tags power
 * @see https://icons.getbootstrap.com/icons/plug-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PlugFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PlugFillIcon aria-label="Plug fill" />
 * ```
 */
...
export const PlugFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PlugFillIcon.displayName = 'PlugFillIcon';

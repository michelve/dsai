 ...
 * NvmeIcon
 *
 * Bootstrap Icons - Nvme
 * @category Devices
 * @tags ssd
 * @see https://icons.getbootstrap.com/icons/nvme/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<NvmeIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <NvmeIcon aria-label="Nvme" />
 * ```
 */
...
export const NvmeIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkBarGraphFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileEarmarkBarGraphFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkBarGraphFillIcon.displayName = 'FileEarmarkBarGraphFillIcon';

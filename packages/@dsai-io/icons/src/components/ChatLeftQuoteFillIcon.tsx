 ...
 *
 * Bootstrap Icons - Chat left quote fill
 * @category Communications
 * @tags chat bubble
 * @see https://icons.getbootstrap.com/icons/chat-left-quote-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ChatLeftQuoteFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ChatLeftQuoteFillIcon aria-label="Chat left quote fill" />
 * ```
 */
...
export const ChatLeftQuoteFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ChatLeftQuoteFillIcon.displayName = 'ChatLeftQuoteFillIcon';

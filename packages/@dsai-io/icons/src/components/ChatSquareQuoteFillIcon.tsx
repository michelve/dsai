 ...
 *
 * Bootstrap Icons - Chat square quote fill
 * @category Communications
 * @tags chat bubble
 * @see https://icons.getbootstrap.com/icons/chat-square-quote-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ChatSquareQuoteFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ChatSquareQuoteFillIcon aria-label="Chat square quote fill" />
 * ```
 */
...
export const ChatSquareQuoteFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ChatSquareQuoteFillIcon.displayName = 'ChatSquareQuoteFillIcon';

 ...
 * FilePlayFillIcon
 *
 * Bootstrap Icons - File play fill
 * @category Files and folders
 * @tags video
 * @see https://icons.getbootstrap.com/icons/file-play-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FilePlayFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FilePlayFillIcon aria-label="File play fill" />
 * ```
 */
...
export const FilePlayFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FilePlayFillIcon.displayName = 'FilePlayFillIcon';

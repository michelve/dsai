 ...
 * ```tsx
 * <Button startIcon={<BookmarkPlusFillIcon />}>Click me</Button>
 * ```
 *
...
export const BookmarkPlusFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BookmarkPlusFillIcon.displayName = 'BookmarkPlusFillIcon';

 ...
 * @category Devices
 * @tags "hard drive"
 * @see https://icons.getbootstrap.com/icons/hdd/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HddIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HddIcon aria-label="Hdd" />
 * ```
 */
...
export const HddIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

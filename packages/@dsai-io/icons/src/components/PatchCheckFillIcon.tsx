 ...
 * ```tsx
 * <Button startIcon={<PatchCheckFillIcon />}>Click me</Button>
 * ```
 *
...
export const PatchCheckFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PatchCheckFillIcon.displayName = 'PatchCheckFillIcon';

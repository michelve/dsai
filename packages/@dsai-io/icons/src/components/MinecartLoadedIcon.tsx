 ...
 * MinecartLoadedIcon
 *
 * Bootstrap Icons - Minecart loaded
 * @category Real world
 * @tags mining
 * @see https://icons.getbootstrap.com/icons/minecart-loaded/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<MinecartLoadedIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <MinecartLoadedIcon aria-label="Minecart loaded" />
 * ```
 */
...
export const MinecartLoadedIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
MinecartLoadedIcon.displayName = 'MinecartLoadedIcon';

 ...
 * FuelPumpDieselIcon
 *
 * Bootstrap Icons - Fuel pump diesel
 * @category Transportation
 * @tags gas
 * @see https://icons.getbootstrap.com/icons/fuel-pump-diesel/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FuelPumpDieselIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FuelPumpDieselIcon aria-label="Fuel pump diesel" />
 * ```
 */
...
export const FuelPumpDieselIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FuelPumpDieselIcon.displayName = 'FuelPumpDieselIcon';

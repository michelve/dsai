 ...
 *
 * Bootstrap Icons - Send arrow down fill
 * @category Communications
 * @tags message
 * @see https://icons.getbootstrap.com/icons/send-arrow-down-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SendArrowDownFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SendArrowDownFillIcon aria-label="Send arrow down fill" />
 * ```
 */
...
export const SendArrowDownFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SendArrowDownFillIcon.displayName = 'SendArrowDownFillIcon';

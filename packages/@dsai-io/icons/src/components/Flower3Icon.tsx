 ...
 * Flower3Icon
 *
 * Bootstrap Icons - Flower3
 * @category Real world
 * @tags plant
 * @see https://icons.getbootstrap.com/icons/flower3/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Flower3Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Flower3Icon aria-label="Flower3" />
 * ```
 */
...
export const Flower3Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Flower3Icon.displayName = 'Flower3Icon';

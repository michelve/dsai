 ...
 * Save2FillIcon
 *
 * Bootstrap Icons - Save2 fill
 * @category UI and keyboard
 * @tags save
 * @see https://icons.getbootstrap.com/icons/save2-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Save2FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Save2FillIcon aria-label="Save2 fill" />
 * ```
 */
...
export const Save2FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Save2FillIcon.displayName = 'Save2FillIcon';

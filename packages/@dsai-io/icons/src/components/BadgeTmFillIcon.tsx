 ...
 * ```tsx
 * <Button startIcon={<BadgeTmFillIcon />}>Click me</Button>
 * ```
 *
...
export const BadgeTmFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
BadgeTmFillIcon.displayName = 'BadgeTmFillIcon';

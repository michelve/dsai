 ...
 * ```tsx
 * <Button startIcon={<InfoSquareFillIcon />}>Click me</Button>
 * ```
 *
...
export const InfoSquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
InfoSquareFillIcon.displayName = 'InfoSquareFillIcon';

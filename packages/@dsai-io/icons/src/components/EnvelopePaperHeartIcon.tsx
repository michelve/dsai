 ...
 *
 * Bootstrap Icons - Envelope paper heart
 * @category Communications
 * @tags email
 * @see https://icons.getbootstrap.com/icons/envelope-paper-heart/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EnvelopePaperHeartIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EnvelopePaperHeartIcon aria-label="Envelope paper heart" />
 * ```
 */
...
export const EnvelopePaperHeartIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EnvelopePaperHeartIcon.displayName = 'EnvelopePaperHeartIcon';

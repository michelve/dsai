 ...
 * ```tsx
 * <Button startIcon={<BuildingFillSlashIcon />}>Click me</Button>
 * ```
 *
...
export const BuildingFillSlashIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
BuildingFillSlashIcon.displayName = 'BuildingFillSlashIcon';

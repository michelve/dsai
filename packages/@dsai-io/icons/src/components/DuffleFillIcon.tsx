 ...
 * ```tsx
 * <Button startIcon={<DuffleFillIcon />}>Click me</Button>
 * ```
 *
...
export const DuffleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
DuffleFillIcon.displayName = 'DuffleFillIcon';

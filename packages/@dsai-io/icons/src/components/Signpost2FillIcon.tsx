 ...
 * ```tsx
 * <Button startIcon={<Signpost2FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Signpost2FillIcon aria-label="Signpost2Fill" />
 * ```
 */
...
export const Signpost2FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Signpost2FillIcon.displayName = 'Signpost2FillIcon';

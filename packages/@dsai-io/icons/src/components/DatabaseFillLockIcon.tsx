 ...
 * ```tsx
 * <Button startIcon={<DatabaseFillLockIcon />}>Click me</Button>
 * ```
 *
...
export const DatabaseFillLockIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
DatabaseFillLockIcon.displayName = 'DatabaseFillLockIcon';

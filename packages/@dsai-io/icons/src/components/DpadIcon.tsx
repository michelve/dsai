 ...
 * @tags gaming
 * @see https://icons.getbootstrap.com/icons/dpad/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DpadIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DpadIcon aria-label="Dpad" />
 * ```
 */
...
export const DpadIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

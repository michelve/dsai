 ...
 * FiletypeM4pIcon
 *
 * Bootstrap Icons - Filetype m4p
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-m4p/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeM4pIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeM4pIcon aria-label="Filetype m4p" />
 * ```
 */
...
export const FiletypeM4pIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FiletypeM4pIcon.displayName = 'FiletypeM4pIcon';

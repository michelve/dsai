 ...
 * ```tsx
 * <Button startIcon={<TextCenterIcon />}>Click me</Button>
 * ```
 *
...
export const TextCenterIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TextCenterIcon.displayName = 'TextCenterIcon';

 ...
 * PersonVideoIcon
 *
 * Bootstrap Icons - Person video
 * @category People
 * @tags human
 * @see https://icons.getbootstrap.com/icons/person-video/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PersonVideoIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PersonVideoIcon aria-label="Person video" />
 * ```
 */
...
export const PersonVideoIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonVideoIcon.displayName = 'PersonVideoIcon';

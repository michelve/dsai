 ...
 * @category Brand
 * @tags frontend
 * @see https://icons.getbootstrap.com/icons/css/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CssIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CssIcon aria-label="CSS" />
 * ```
 */
...
export const CssIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

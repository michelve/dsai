 ...
 * FileArrowDownIcon
 *
 * Bootstrap Icons - File arrow down
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-arrow-down/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileArrowDownIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileArrowDownIcon aria-label="File arrow down" />
 * ```
 */
...
export const FileArrowDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileArrowDownIcon.displayName = 'FileArrowDownIcon';

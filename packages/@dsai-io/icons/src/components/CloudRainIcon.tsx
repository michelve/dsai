 ...
 * CloudRainIcon
 *
 * Bootstrap Icons - Cloud rain
 * @category Weather
 * @tags cloud
 * @see https://icons.getbootstrap.com/icons/cloud-rain/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudRainIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudRainIcon aria-label="Cloud rain" />
 * ```
 */

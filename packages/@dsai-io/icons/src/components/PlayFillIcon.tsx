 ...
 * @category Media
 * @tags audio
 * @see https://icons.getbootstrap.com/icons/play-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PlayFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PlayFillIcon aria-label="Play fill" />
 * ```
 */
...
export const PlayFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

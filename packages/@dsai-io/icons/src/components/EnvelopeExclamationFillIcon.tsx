 ...
 * ```tsx
 * <Button startIcon={<EnvelopeExclamationFillIcon />}>Click me</Button>
 * ```
 *
...
export const EnvelopeExclamationFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EnvelopeExclamationFillIcon.displayName = 'EnvelopeExclamationFillIcon';

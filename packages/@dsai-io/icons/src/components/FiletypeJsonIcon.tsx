 ...
 * ```tsx
 * <Button startIcon={<FiletypeJsonIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypeJsonIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FiletypeJsonIcon.displayName = 'FiletypeJsonIcon';

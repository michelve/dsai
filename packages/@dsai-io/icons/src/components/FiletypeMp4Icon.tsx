 ...
 * ```tsx
 * <Button startIcon={<FiletypeMp4Icon />}>Click me</Button>
 * ```
 *
...
export const FiletypeMp4Icon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FiletypeMp4Icon.displayName = 'FiletypeMp4Icon';

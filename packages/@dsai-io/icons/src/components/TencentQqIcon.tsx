 ...
 * TencentQqIcon
 *
 * Bootstrap Icons - Tencent QQ
 * @category Brand
 * @tags social
 * @see https://icons.getbootstrap.com/icons/tencent-qq/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TencentQqIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TencentQqIcon aria-label="Tencent QQ" />
 * ```
 */
...
export const TencentQqIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TencentQqIcon.displayName = 'TencentQqIcon';

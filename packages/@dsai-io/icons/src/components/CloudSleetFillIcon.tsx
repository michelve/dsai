 ...
 * CloudSleetFillIcon
 *
 * Bootstrap Icons - Cloud sleet fill
 * @category Weather
 * @tags cloud
 * @see https://icons.getbootstrap.com/icons/cloud-sleet-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudSleetFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudSleetFillIcon aria-label="Cloud sleet fill" />
 * ```
 */
...
export const CloudSleetFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
CloudSleetFillIcon.displayName = 'CloudSleetFillIcon';

 ...
 * PersonFillSlashIcon
 *
 * Bootstrap Icons - Person fill slash
 * @category People
 * @tags member
 * @see https://icons.getbootstrap.com/icons/person-fill-slash/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PersonFillSlashIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PersonFillSlashIcon aria-label="Person fill slash" />
 * ```
 */
...
export const PersonFillSlashIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonFillSlashIcon.displayName = 'PersonFillSlashIcon';

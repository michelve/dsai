 ...
 * ```tsx
 * <Button startIcon={<SourceforgeIcon />}>Click me</Button>
 * ```
 *
...
export const SourceforgeIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
SourceforgeIcon.displayName = 'SourceforgeIcon';

 ...
 *
 * Bootstrap Icons - Arrow down left square
 * @category Shape arrows
 * @tags arrow
 * @see https://icons.getbootstrap.com/icons/arrow-down-left-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ArrowDownLeftSquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ArrowDownLeftSquareIcon aria-label="Arrow down left square" />
 * ```
 */
...
export const ArrowDownLeftSquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowDownLeftSquareIcon.displayName = 'ArrowDownLeftSquareIcon';

 ...
 * BezierIcon
 *
 * Bootstrap Icons - Bezier
 * @category Graphics
 * @tags graphics
 * @see https://icons.getbootstrap.com/icons/bezier/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BezierIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BezierIcon aria-label="Bezier" />
 * ```
 */
...
export const BezierIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

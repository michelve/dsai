 ...
 * ```tsx
 * <Button startIcon={<ArrowDownRightSquareIcon />}>Click me</Button>
 * ```
 *
...
export const ArrowDownRightSquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowDownRightSquareIcon.displayName = 'ArrowDownRightSquareIcon';

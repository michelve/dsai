 ...
 * FileZipIcon
 *
 * Bootstrap Icons - File zip
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-zip/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileZipIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileZipIcon aria-label="File zip" />
 * ```
 */
...
export const FileZipIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<SkipStartBtnIcon />}>Click me</Button>
 * ```
 *
...
export const SkipStartBtnIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SkipStartBtnIcon.displayName = 'SkipStartBtnIcon';

 ...
 * Mailbox2FlagIcon
 *
 * Bootstrap Icons - Mailbox2 flag
 * @category Real world
 * @tags post
 * @see https://icons.getbootstrap.com/icons/mailbox2-flag/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Mailbox2FlagIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Mailbox2FlagIcon aria-label="Mailbox2 flag" />
 * ```
 */
...
export const Mailbox2FlagIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
Mailbox2FlagIcon.displayName = 'Mailbox2FlagIcon';

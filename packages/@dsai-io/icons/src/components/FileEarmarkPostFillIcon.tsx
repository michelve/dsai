 ...
 *
 * Bootstrap Icons - File earmark post fill
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-earmark-post-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkPostFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileEarmarkPostFillIcon aria-label="File earmark post fill" />
 * ```
 */
...
export const FileEarmarkPostFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkPostFillIcon.displayName = 'FileEarmarkPostFillIcon';

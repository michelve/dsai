 ...
 * ```tsx
 * <Button startIcon={<NoiseReductionIcon />}>Click me</Button>
 * ```
 *
...
export const NoiseReductionIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
NoiseReductionIcon.displayName = 'NoiseReductionIcon';

 ...
 * ```tsx
 * <Button startIcon={<BrillianceIcon />}>Click me</Button>
 * ```
 *
...
export const BrillianceIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BrillianceIcon.displayName = 'BrillianceIcon';

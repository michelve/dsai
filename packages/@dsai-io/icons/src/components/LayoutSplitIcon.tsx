 ...
 * ```tsx
 * <Button startIcon={<LayoutSplitIcon />}>Click me</Button>
 * ```
 *
...
export const LayoutSplitIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
LayoutSplitIcon.displayName = 'LayoutSplitIcon';

 ...
 * ```tsx
 * <Button startIcon={<Reception3Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Reception3Icon aria-label="Reception3" />
 * ```
 */
...
export const Reception3Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Reception3Icon.displayName = 'Reception3Icon';

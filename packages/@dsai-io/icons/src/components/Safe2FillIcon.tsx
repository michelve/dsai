 ...
 * Safe2FillIcon
 *
 * Bootstrap Icons - Safe2 fill
 * @category Real world
 * @tags vault
 * @see https://icons.getbootstrap.com/icons/safe2-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Safe2FillIcon />}>Click me</Button>
 * ```
 *
...
Safe2FillIcon.displayName = 'Safe2FillIcon';

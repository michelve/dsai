 ...
 * ```tsx
 * <Button startIcon={<TelephonePlusFillIcon />}>Click me</Button>
 * ```
 *
...
export const TelephonePlusFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TelephonePlusFillIcon.displayName = 'TelephonePlusFillIcon';

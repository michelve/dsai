 ...
 *
 * Bootstrap Icons - Sign intersection t
 * @category Transportation
 * @tags road
 * @see https://icons.getbootstrap.com/icons/sign-intersection-t/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignIntersectionTIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignIntersectionTIcon aria-label="Sign intersection t" />
 * ```
 */
...
export const SignIntersectionTIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignIntersectionTIcon.displayName = 'SignIntersectionTIcon';

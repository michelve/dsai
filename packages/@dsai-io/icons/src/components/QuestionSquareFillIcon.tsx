 ...
 * ```tsx
 * <Button startIcon={<QuestionSquareFillIcon />}>Click me</Button>
 * ```
 *
...
export const QuestionSquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
QuestionSquareFillIcon.displayName = 'QuestionSquareFillIcon';

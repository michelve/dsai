 ...
 * ArrowsIcon
 *
 * Bootstrap Icons - Arrows
 * @category Arrows
 * @tags arrow
 * @see https://icons.getbootstrap.com/icons/arrows/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ArrowsIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ArrowsIcon aria-label="Arrows" />
 * ```
 */
...
export const ArrowsIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

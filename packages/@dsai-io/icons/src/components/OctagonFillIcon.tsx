 ...
 * ```tsx
 * <Button startIcon={<OctagonFillIcon />}>Click me</Button>
 * ```
 *
...
export const OctagonFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
OctagonFillIcon.displayName = 'OctagonFillIcon';

 ...
 * PCircleIcon
 *
 * Bootstrap Icons - P circle
 * @category Shapes
 * @tags parking
 * @see https://icons.getbootstrap.com/icons/p-circle/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PCircleIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PCircleIcon aria-label="P circle" />
 * ```
 */
...
export const PCircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PCircleIcon.displayName = 'PCircleIcon';

 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkLockFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileEarmarkLockFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkLockFillIcon.displayName = 'FileEarmarkLockFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<RCircleFillIcon />}>Click me</Button>
 * ```
 *
...
export const RCircleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
RCircleFillIcon.displayName = 'RCircleFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<TypeStrikethroughIcon />}>Click me</Button>
 * ```
 *
...
export const TypeStrikethroughIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
TypeStrikethroughIcon.displayName = 'TypeStrikethroughIcon';

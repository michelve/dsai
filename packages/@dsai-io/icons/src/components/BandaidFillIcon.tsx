 ...
 * BandaidFillIcon
 *
 * Bootstrap Icons - Bandaid fill
 * @category Real world
 * @tags bandage
 * @see https://icons.getbootstrap.com/icons/bandaid-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BandaidFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BandaidFillIcon aria-label="Bandaid fill" />
 * ```
 */
...
export const BandaidFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
BandaidFillIcon.displayName = 'BandaidFillIcon';

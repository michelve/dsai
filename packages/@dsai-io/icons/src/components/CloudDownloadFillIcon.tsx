 ...
 * ```tsx
 * <Button startIcon={<CloudDownloadFillIcon />}>Click me</Button>
 * ```
 *
...
export const CloudDownloadFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudDownloadFillIcon.displayName = 'CloudDownloadFillIcon';

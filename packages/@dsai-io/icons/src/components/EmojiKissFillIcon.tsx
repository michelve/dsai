 ...
 * EmojiKissFillIcon
 *
 * Bootstrap Icons - Emoji kiss fill
 * @category Emoji
 * @tags emoticon
 * @see https://icons.getbootstrap.com/icons/emoji-kiss-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EmojiKissFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EmojiKissFillIcon aria-label="Emoji kiss fill" />
 * ```
 */
...
export const EmojiKissFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
EmojiKissFillIcon.displayName = 'EmojiKissFillIcon';

 ...
 * ClipboardXIcon
 *
 * Bootstrap Icons - Clipboard x
 * @category Real world
 * @tags copy
 * @see https://icons.getbootstrap.com/icons/clipboard-x/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ClipboardXIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ClipboardXIcon aria-label="Clipboard x" />
 * ```
 */

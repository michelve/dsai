 ...
 * ```tsx
 * <Button startIcon={<Reception0Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Reception0Icon aria-label="Reception0" />
 * ```
 */
...
export const Reception0Icon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
Reception0Icon.displayName = 'Reception0Icon';

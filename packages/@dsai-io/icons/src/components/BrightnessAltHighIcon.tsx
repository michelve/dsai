 ...
 *
 * Bootstrap Icons - Brightness alt high
 * @category UI and keyboard
 * @tags brightness
 * @see https://icons.getbootstrap.com/icons/brightness-alt-high/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BrightnessAltHighIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BrightnessAltHighIcon aria-label="Brightness alt high" />
 * ```
 */
...
export const BrightnessAltHighIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BrightnessAltHighIcon.displayName = 'BrightnessAltHighIcon';

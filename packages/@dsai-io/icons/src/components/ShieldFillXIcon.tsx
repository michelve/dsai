 ...
 * ShieldFillXIcon
 *
 * Bootstrap Icons - Shield fill x
 * @category Security
 * @tags privacy
 * @see https://icons.getbootstrap.com/icons/shield-fill-x/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ShieldFillXIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ShieldFillXIcon aria-label="Shield fill x" />
 * ```
 */
...
export const ShieldFillXIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ShieldFillXIcon.displayName = 'ShieldFillXIcon';

 ...
 * Icon0SquareFillIcon
 *
 * Bootstrap Icons - 0 square fill
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/0-square-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon0SquareFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon0SquareFillIcon aria-label="0 square fill" />
 * ```
 */
...
export const Icon0SquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon0SquareFillIcon.displayName = 'Icon0SquareFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<GlobeAmericasFillIcon />}>Click me</Button>
 * ```
 *
...
export const GlobeAmericasFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
GlobeAmericasFillIcon.displayName = 'GlobeAmericasFillIcon';

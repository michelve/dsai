 ...
 * BagXIcon
 *
 * Bootstrap Icons - Bag x
 * @category Commerce
 * @tags shopping
 * @see https://icons.getbootstrap.com/icons/bag-x/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BagXIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BagXIcon aria-label="Bag x" />
 * ```
 */
...
export const BagXIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<QuestionDiamondFillIcon />}>Click me</Button>
 * ```
 *
...
export const QuestionDiamondFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
QuestionDiamondFillIcon.displayName = 'QuestionDiamondFillIcon';

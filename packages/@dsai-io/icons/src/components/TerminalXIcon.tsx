 ...
 * TerminalXIcon
 *
 * Bootstrap Icons - Terminal x
 * @category Apps
 * @tags command-line
 * @see https://icons.getbootstrap.com/icons/terminal-x/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TerminalXIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TerminalXIcon aria-label="Terminal x" />
 * ```
 */
...
export const TerminalXIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TerminalXIcon.displayName = 'TerminalXIcon';

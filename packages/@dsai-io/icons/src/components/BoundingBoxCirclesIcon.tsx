 ...
 * ```tsx
 * <Button startIcon={<BoundingBoxCirclesIcon />}>Click me</Button>
 * ```
 *
...
export const BoundingBoxCirclesIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BoundingBoxCirclesIcon.displayName = 'BoundingBoxCirclesIcon';

 ...
 * ShiftFillIcon
 *
 * Bootstrap Icons - Shift fill
 * @category UI and keyboard
 * @tags key
 * @see https://icons.getbootstrap.com/icons/shift-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ShiftFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ShiftFillIcon aria-label="Shift fill" />
 * ```
 */
...
export const ShiftFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ShiftFillIcon.displayName = 'ShiftFillIcon';

 ...
 * BoxArrowUpLeftIcon
 *
 * Bootstrap Icons - Box arrow up-left
 * @category Box arrows
 * @tags arrow
 * @see https://icons.getbootstrap.com/icons/box-arrow-up-left/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BoxArrowUpLeftIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BoxArrowUpLeftIcon aria-label="Box arrow up-left" />
 * ```
 */
...
export const BoxArrowUpLeftIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
BoxArrowUpLeftIcon.displayName = 'BoxArrowUpLeftIcon';

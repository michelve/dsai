 ...
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-earmark-zip-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkZipFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileEarmarkZipFillIcon aria-label="File earmark zip fill" />
 * ```
 */
...
export const FileEarmarkZipFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FileEarmarkZipFillIcon.displayName = 'FileEarmarkZipFillIcon';

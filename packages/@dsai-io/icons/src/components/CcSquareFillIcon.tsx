 ...
 * ```tsx
 * <Button startIcon={<CcSquareFillIcon />}>Click me</Button>
 * ```
 *
...
export const CcSquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CcSquareFillIcon.displayName = 'CcSquareFillIcon';

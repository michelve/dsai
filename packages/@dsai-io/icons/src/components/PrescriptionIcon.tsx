 ...
 * PrescriptionIcon
 *
 * Bootstrap Icons - Prescription
 * @category Medical
 * @tags rx
 * @see https://icons.getbootstrap.com/icons/prescription/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PrescriptionIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PrescriptionIcon aria-label="Prescription" />
 * ```
 */
...
export const PrescriptionIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

 ...
 * ShieldPlusIcon
 *
 * Bootstrap Icons - Shield plus
 * @category Security
 * @tags privacy
 * @see https://icons.getbootstrap.com/icons/shield-plus/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ShieldPlusIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ShieldPlusIcon aria-label="Shield plus" />
 * ```
 */
...
export const ShieldPlusIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

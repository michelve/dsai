 ...
 * Arrow90degDownIcon
 *
 * Bootstrap Icons - Arrow90degDown
 ...
 * ```tsx
 * <Button startIcon={<Arrow90degDownIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Arrow90degDownIcon aria-label="Arrow90degDown" />
 * ```
 */
...
export const Arrow90degDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Arrow90degDownIcon.displayName = 'Arrow90degDownIcon';

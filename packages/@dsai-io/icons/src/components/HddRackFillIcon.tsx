 ...
 * ```tsx
 * <Button startIcon={<HddRackFillIcon />}>Click me</Button>
 * ```
 *
...
export const HddRackFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HddRackFillIcon.displayName = 'HddRackFillIcon';

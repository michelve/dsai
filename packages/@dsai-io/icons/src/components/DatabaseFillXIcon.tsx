 ...
 * DatabaseFillXIcon
 *
 * Bootstrap Icons - Database fill x
 * @category Devices
 * @tags server
 * @see https://icons.getbootstrap.com/icons/database-fill-x/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DatabaseFillXIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DatabaseFillXIcon aria-label="Database fill x" />
 * ```
 */
...
export const DatabaseFillXIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DatabaseFillXIcon.displayName = 'DatabaseFillXIcon';

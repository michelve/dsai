 ...
 * FiletypePptIcon
 *
 * Bootstrap Icons - Filetype ppt
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-ppt/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypePptIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypePptIcon aria-label="Filetype ppt" />
 * ```
 */
...
export const FiletypePptIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

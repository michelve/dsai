 ...
 *
 * Bootstrap Icons - Sign stop lights fill
 * @category Transportation
 * @tags "stop sign"
 * @see https://icons.getbootstrap.com/icons/sign-stop-lights-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignStopLightsFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignStopLightsFillIcon aria-label="Sign stop lights fill" />
 * ```
 */
...
export const SignStopLightsFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignStopLightsFillIcon.displayName = 'SignStopLightsFillIcon';

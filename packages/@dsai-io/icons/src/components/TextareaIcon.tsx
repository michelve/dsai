 ...
 * TextareaIcon
 *
 * Bootstrap Icons - Textarea
 * @category Graphics
 * @tags text
 * @see https://icons.getbootstrap.com/icons/textarea/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TextareaIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TextareaIcon aria-label="Textarea" />
 * ```
 */
...
export const TextareaIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

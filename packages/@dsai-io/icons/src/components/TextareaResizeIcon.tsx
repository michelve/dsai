 ...
 * ```tsx
 * <Button startIcon={<TextareaResizeIcon />}>Click me</Button>
 * ```
 *
...
export const TextareaResizeIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TextareaResizeIcon.displayName = 'TextareaResizeIcon';

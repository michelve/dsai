 ...
 * @category Weather
 * @tags cloud
 * @see https://icons.getbootstrap.com/icons/cloud-rain-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudRainFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudRainFillIcon aria-label="Cloud rain fill" />
 * ```
 */
...
export const CloudRainFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudRainFillIcon.displayName = 'CloudRainFillIcon';

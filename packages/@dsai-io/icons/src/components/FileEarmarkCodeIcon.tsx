 ...
 * FileEarmarkCodeIcon
 *
 * Bootstrap Icons - File earmark code
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-earmark-code/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkCodeIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileEarmarkCodeIcon aria-label="File earmark code" />
 * ```
 */
...
export const FileEarmarkCodeIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkCodeIcon.displayName = 'FileEarmarkCodeIcon';

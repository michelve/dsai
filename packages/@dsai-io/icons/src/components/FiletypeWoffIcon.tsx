 ...
 * ```tsx
 * <Button startIcon={<FiletypeWoffIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypeWoffIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FiletypeWoffIcon.displayName = 'FiletypeWoffIcon';

 ...
 * ```tsx
 * <Button startIcon={<WindowDockIcon />}>Click me</Button>
 * ```
 *
...
export const WindowDockIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
WindowDockIcon.displayName = 'WindowDockIcon';

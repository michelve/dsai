 ...
 * CCircleFillIcon
 *
 * Bootstrap Icons - C circle fill
 * @category Shapes
 * @tags copyright
 * @see https://icons.getbootstrap.com/icons/c-circle-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CCircleFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CCircleFillIcon aria-label="C circle fill" />
 * ```
 */
...
export const CCircleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
CCircleFillIcon.displayName = 'CCircleFillIcon';

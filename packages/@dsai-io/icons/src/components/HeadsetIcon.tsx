 ...
 * @category Devices
 * @tags headphones
 * @see https://icons.getbootstrap.com/icons/headset/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HeadsetIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HeadsetIcon aria-label="Headset" />
 * ```
 */
...
export const HeadsetIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

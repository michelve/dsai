 ...
 * VolumeDownIcon
 *
 * Bootstrap Icons - Volume down
 * @category Media
 * @tags audio
 * @see https://icons.getbootstrap.com/icons/volume-down/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<VolumeDownIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <VolumeDownIcon aria-label="Volume down" />
 * ```
 */
...
export const VolumeDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

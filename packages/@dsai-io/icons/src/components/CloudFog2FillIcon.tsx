 ...
 * @category Weather
 * @tags foggy
 * @see https://icons.getbootstrap.com/icons/cloud-fog2-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudFog2FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudFog2FillIcon aria-label="Cloud fog2 fill" />
 * ```
 */
...
export const CloudFog2FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudFog2FillIcon.displayName = 'CloudFog2FillIcon';

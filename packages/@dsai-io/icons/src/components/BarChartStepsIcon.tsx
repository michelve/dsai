 ...
 * ```tsx
 * <Button startIcon={<BarChartStepsIcon />}>Click me</Button>
 * ```
 *
...
export const BarChartStepsIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BarChartStepsIcon.displayName = 'BarChartStepsIcon';

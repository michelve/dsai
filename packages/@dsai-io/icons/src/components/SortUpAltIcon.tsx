 ...
 * SortUpAltIcon
 *
 * Bootstrap Icons - Sort up alt
 * @category Sort and filter
 * @tags sort
 * @see https://icons.getbootstrap.com/icons/sort-up-alt/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SortUpAltIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SortUpAltIcon aria-label="Sort up alt" />
 * ```
 */
...
export const SortUpAltIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SortUpAltIcon.displayName = 'SortUpAltIcon';

 ...
 * FileWordFillIcon
 *
 * Bootstrap Icons - File word fill
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-word-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileWordFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileWordFillIcon aria-label="File word fill" />
 * ```
 */
...
export const FileWordFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileWordFillIcon.displayName = 'FileWordFillIcon';

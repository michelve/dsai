 ...
 * ```tsx
 * <Button startIcon={<PatchExclamationFillIcon />}>Click me</Button>
 * ```
 *
...
export const PatchExclamationFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PatchExclamationFillIcon.displayName = 'PatchExclamationFillIcon';

 ...
 * SuitSpadeFillIcon
 *
 * Bootstrap Icons - Suit spade fill
 * @category Entertainment
 * @tags card
 * @see https://icons.getbootstrap.com/icons/suit-spade-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SuitSpadeFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SuitSpadeFillIcon aria-label="Suit spade fill" />
 * ```
 */
...
export const SuitSpadeFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SuitSpadeFillIcon.displayName = 'SuitSpadeFillIcon';

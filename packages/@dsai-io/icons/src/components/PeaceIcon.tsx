 ...
 * PeaceIcon
 *
 * Bootstrap Icons - Peace
 * @category Miscellaneous
 * @tags peace
 * @see https://icons.getbootstrap.com/icons/peace/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PeaceIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PeaceIcon aria-label="Peace" />
 * ```
 */
...
export const PeaceIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * BagXFillIcon
 *
 * Bootstrap Icons - Bag x fill
 * @category Commerce
 * @tags shopping
 * @see https://icons.getbootstrap.com/icons/bag-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BagXFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BagXFillIcon aria-label="Bag x fill" />
 * ```
 */
...
export const BagXFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BagXFillIcon.displayName = 'BagXFillIcon';

 ...
 *
 * Bootstrap Icons - Calendar plus fill
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar-plus-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CalendarPlusFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CalendarPlusFillIcon aria-label="Calendar plus fill" />
 * ```
 */
...
export const CalendarPlusFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<FileImageFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileImageFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileImageFillIcon.displayName = 'FileImageFillIcon';

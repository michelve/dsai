 ...
 * ```tsx
 * <Button startIcon={<ArrowsAngleExpandIcon />}>Click me</Button>
 * ```
 *
...
export const ArrowsAngleExpandIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowsAngleExpandIcon.displayName = 'ArrowsAngleExpandIcon';

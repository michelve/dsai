 ...
 * FiletypeCsIcon
 *
 * Bootstrap Icons - Filetype cs
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-cs/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeCsIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeCsIcon aria-label="Filetype cs" />
 * ```
 */
...
export const FiletypeCsIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FiletypeCsIcon.displayName = 'FiletypeCsIcon';

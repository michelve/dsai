 ...
 * ```tsx
 * <Button startIcon={<PersonSlashIcon />}>Click me</Button>
 * ```
 *
...
export const PersonSlashIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
PersonSlashIcon.displayName = 'PersonSlashIcon';

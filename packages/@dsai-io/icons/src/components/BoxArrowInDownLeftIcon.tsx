 ...
 * @category Box arrows
 * @tags arrow
 * @see https://icons.getbootstrap.com/icons/box-arrow-in-down-left/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BoxArrowInDownLeftIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BoxArrowInDownLeftIcon aria-label="Box arrow in down left" />
 * ```
 */
...
export const BoxArrowInDownLeftIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
BoxArrowInDownLeftIcon.displayName = 'BoxArrowInDownLeftIcon';

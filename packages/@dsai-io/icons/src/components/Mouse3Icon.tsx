 ...
 * Mouse3Icon
 *
 * Bootstrap Icons - Mouse3
 * @category Devices
 * @tags mice
 * @see https://icons.getbootstrap.com/icons/mouse3/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Mouse3Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Mouse3Icon aria-label="Mouse3" />
 * ```
 */
...
export const Mouse3Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

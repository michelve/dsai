 ...
 * ```tsx
 * <Button startIcon={<FiletypePsdIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypePsdIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FiletypePsdIcon.displayName = 'FiletypePsdIcon';

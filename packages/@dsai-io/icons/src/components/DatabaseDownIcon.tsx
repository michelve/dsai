 ...
 * DatabaseDownIcon
 *
 * Bootstrap Icons - Database down
 * @category Devices
 * @tags server
 * @see https://icons.getbootstrap.com/icons/database-down/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DatabaseDownIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DatabaseDownIcon aria-label="Database down" />
 * ```
 */
...
export const DatabaseDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DatabaseDownIcon.displayName = 'DatabaseDownIcon';

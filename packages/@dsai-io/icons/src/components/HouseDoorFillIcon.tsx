 ...
 * ```tsx
 * <Button startIcon={<HouseDoorFillIcon />}>Click me</Button>
 * ```
 *
...
export const HouseDoorFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HouseDoorFillIcon.displayName = 'HouseDoorFillIcon';

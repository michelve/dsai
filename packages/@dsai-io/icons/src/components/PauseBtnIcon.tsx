 ...
 * PauseBtnIcon
 *
 * Bootstrap Icons - Pause btn
 * @category Media
 * @tags audio
 * @see https://icons.getbootstrap.com/icons/pause-btn/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PauseBtnIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PauseBtnIcon aria-label="Pause btn" />
 * ```
 */
...
export const PauseBtnIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PauseBtnIcon.displayName = 'PauseBtnIcon';

 ...
 * ```tsx
 * <Button startIcon={<ArrowsExpandVerticalIcon />}>Click me</Button>
 * ```
 *
...
export const ArrowsExpandVerticalIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowsExpandVerticalIcon.displayName = 'ArrowsExpandVerticalIcon';

 ...
 * BookmarkXIcon
 *
 * Bootstrap Icons - Bookmark x
 * @category Miscellaneous
 * @tags reading
 * @see https://icons.getbootstrap.com/icons/bookmark-x/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BookmarkXIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BookmarkXIcon aria-label="Bookmark x" />
 * ```
 */
...
export const BookmarkXIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

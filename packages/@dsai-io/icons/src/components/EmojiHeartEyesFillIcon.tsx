 ...
 *
 * Bootstrap Icons - Emoji heart eyes fill
 * @category Emoji
 * @tags emoticon
 * @see https://icons.getbootstrap.com/icons/emoji-heart-eyes-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EmojiHeartEyesFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EmojiHeartEyesFillIcon aria-label="Emoji heart eyes fill" />
 * ```
 */
...
export const EmojiHeartEyesFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EmojiHeartEyesFillIcon.displayName = 'EmojiHeartEyesFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<Diagram2FillIcon />}>Click me</Button>
 * ```
 *
...
export const Diagram2FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Diagram2FillIcon.displayName = 'Diagram2FillIcon';

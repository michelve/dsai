 ...
 * @category Security
 * @tags privacy
 * @see https://icons.getbootstrap.com/icons/unlock-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<UnlockFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <UnlockFillIcon aria-label="Unlock fill" />
 * ```
 */
...
export const UnlockFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
UnlockFillIcon.displayName = 'UnlockFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<FileBinaryIcon />}>Click me</Button>
 * ```
 *
...
export const FileBinaryIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FileBinaryIcon.displayName = 'FileBinaryIcon';

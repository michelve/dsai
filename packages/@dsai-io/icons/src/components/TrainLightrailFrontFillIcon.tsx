 ...
 *
 * Bootstrap Icons - Train lightrail front fill
 * @category Transportation
 * @tags transit
 * @see https://icons.getbootstrap.com/icons/train-lightrail-front-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TrainLightrailFrontFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TrainLightrailFrontFillIcon aria-label="Train lightrail front fill" />
 * ```
 */
...
export const TrainLightrailFrontFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
TrainLightrailFrontFillIcon.displayName = 'TrainLightrailFrontFillIcon';

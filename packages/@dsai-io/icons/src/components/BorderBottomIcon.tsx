 ...
 * BorderBottomIcon
 *
 * Bootstrap Icons - Border bottom
 * @category UI and keyboard
 * @tags borders
 * @see https://icons.getbootstrap.com/icons/border-bottom/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BorderBottomIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BorderBottomIcon aria-label="Border bottom" />
 * ```
 */
...
export const BorderBottomIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<BadgeVrFillIcon />}>Click me</Button>
 * ```
 *
...
export const BadgeVrFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BadgeVrFillIcon.displayName = 'BadgeVrFillIcon';

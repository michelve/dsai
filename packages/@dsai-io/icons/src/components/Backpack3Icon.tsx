 ...
 * Backpack3Icon
 *
 * Bootstrap Icons - Backpack3
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/backpack3/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Backpack3Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Backpack3Icon aria-label="Backpack3" />
 * ```
 */
...
export const Backpack3Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

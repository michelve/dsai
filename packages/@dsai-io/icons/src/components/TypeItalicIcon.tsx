 ...
 * ```tsx
 * <Button startIcon={<TypeItalicIcon />}>Click me</Button>
 * ```
 *
...
export const TypeItalicIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TypeItalicIcon.displayName = 'TypeItalicIcon';

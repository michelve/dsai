 ...
 * ```tsx
 * <Button startIcon={<JournalCheckIcon />}>Click me</Button>
 * ```
 *
...
export const JournalCheckIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
JournalCheckIcon.displayName = 'JournalCheckIcon';

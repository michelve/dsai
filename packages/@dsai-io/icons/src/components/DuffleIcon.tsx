 ...
 * DuffleIcon
 *
 * Bootstrap Icons - Duffle
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/duffle/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DuffleIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DuffleIcon aria-label="Duffle" />
 * ```
 */
...
export const DuffleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DuffleIcon.displayName = 'DuffleIcon';

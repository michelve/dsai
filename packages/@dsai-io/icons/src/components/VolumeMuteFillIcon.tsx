 ...
 * ```tsx
 * <Button startIcon={<VolumeMuteFillIcon />}>Click me</Button>
 * ```
 *
...
export const VolumeMuteFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
VolumeMuteFillIcon.displayName = 'VolumeMuteFillIcon';

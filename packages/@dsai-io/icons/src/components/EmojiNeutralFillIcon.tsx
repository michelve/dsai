 ...
 * ```tsx
 * <Button startIcon={<EmojiNeutralFillIcon />}>Click me</Button>
 * ```
 *
...
export const EmojiNeutralFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EmojiNeutralFillIcon.displayName = 'EmojiNeutralFillIcon';

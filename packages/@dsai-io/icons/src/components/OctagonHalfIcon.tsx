 ...
 * ```tsx
 * <Button startIcon={<OctagonHalfIcon />}>Click me</Button>
 * ```
 *
...
export const OctagonHalfIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
OctagonHalfIcon.displayName = 'OctagonHalfIcon';

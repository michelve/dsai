 ...
 * ```tsx
 * <Button startIcon={<Badge3dFillIcon />}>Click me</Button>
 * ```
 *
...
export const Badge3dFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Badge3dFillIcon.displayName = 'Badge3dFillIcon';

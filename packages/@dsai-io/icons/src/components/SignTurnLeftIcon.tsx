 ...
 * SignTurnLeftIcon
 *
 * Bootstrap Icons - Sign turn left
 * @category Transportation
 * @tags road
 * @see https://icons.getbootstrap.com/icons/sign-turn-left/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignTurnLeftIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignTurnLeftIcon aria-label="Sign turn left" />
 * ```
 */
...
export const SignTurnLeftIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignTurnLeftIcon.displayName = 'SignTurnLeftIcon';

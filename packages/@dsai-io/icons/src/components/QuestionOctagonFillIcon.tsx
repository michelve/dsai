 ...
 * ```tsx
 * <Button startIcon={<QuestionOctagonFillIcon />}>Click me</Button>
 * ```
 *
...
export const QuestionOctagonFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
QuestionOctagonFillIcon.displayName = 'QuestionOctagonFillIcon';

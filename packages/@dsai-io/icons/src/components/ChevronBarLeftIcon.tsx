 ...
 * ```tsx
 * <Button startIcon={<ChevronBarLeftIcon />}>Click me</Button>
 * ```
 *
...
export const ChevronBarLeftIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ChevronBarLeftIcon.displayName = 'ChevronBarLeftIcon';

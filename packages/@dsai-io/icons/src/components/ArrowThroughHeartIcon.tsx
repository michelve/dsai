 ...
 *
 * Bootstrap Icons - Arrow through heart
 * @category Arrows
 * @tags cupid
 * @see https://icons.getbootstrap.com/icons/arrow-through-heart/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ArrowThroughHeartIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ArrowThroughHeartIcon aria-label="Arrow through heart" />
 * ```
 */
...
export const ArrowThroughHeartIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowThroughHeartIcon.displayName = 'ArrowThroughHeartIcon';

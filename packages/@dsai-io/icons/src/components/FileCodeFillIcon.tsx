 ...
 * ```tsx
 * <Button startIcon={<FileCodeFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileCodeFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileCodeFillIcon.displayName = 'FileCodeFillIcon';

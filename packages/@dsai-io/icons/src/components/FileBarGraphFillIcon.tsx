 ...
 * ```tsx
 * <Button startIcon={<FileBarGraphFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileBarGraphFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileBarGraphFillIcon.displayName = 'FileBarGraphFillIcon';

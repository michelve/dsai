 ...
 * ```tsx
 * <Button startIcon={<LayoutSidebarInsetIcon />}>Click me</Button>
 * ```
 *
...
export const LayoutSidebarInsetIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
LayoutSidebarInsetIcon.displayName = 'LayoutSidebarInsetIcon';

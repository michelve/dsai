 ...
 * BuildingLockIcon
 *
 * Bootstrap Icons - Building lock
 * @category Buildings
 * @tags company
 * @see https://icons.getbootstrap.com/icons/building-lock/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BuildingLockIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BuildingLockIcon aria-label="Building lock" />
 * ```
 */
...
export const BuildingLockIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BuildingLockIcon.displayName = 'BuildingLockIcon';

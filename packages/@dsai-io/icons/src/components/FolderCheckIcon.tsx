 ...
 * FolderCheckIcon
 *
 * Bootstrap Icons - Folder check
 * @category Files and folders
 * @tags directory
 * @see https://icons.getbootstrap.com/icons/folder-check/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FolderCheckIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FolderCheckIcon aria-label="Folder check" />
 * ```
 */
...
export const FolderCheckIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

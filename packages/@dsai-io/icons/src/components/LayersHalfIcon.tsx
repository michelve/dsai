 ...
 * ```tsx
 * <Button startIcon={<LayersHalfIcon />}>Click me</Button>
 * ```
 *
...
export const LayersHalfIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
LayersHalfIcon.displayName = 'LayersHalfIcon';

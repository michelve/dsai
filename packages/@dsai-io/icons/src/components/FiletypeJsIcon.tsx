 ...
 * FiletypeJsIcon
 *
 * Bootstrap Icons - Filetype js
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-js/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeJsIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeJsIcon aria-label="Filetype js" />
 * ```
 */
...
export const FiletypeJsIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

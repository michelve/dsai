 ...
 * ```tsx
 * <Button startIcon={<ShieldFillPlusIcon />}>Click me</Button>
 * ```
 *
...
export const ShieldFillPlusIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
ShieldFillPlusIcon.displayName = 'ShieldFillPlusIcon';

 ...
 * ```tsx
 * <Button startIcon={<CreditCard2BackFillIcon />}>Click me</Button>
 * ```
 *
...
export const CreditCard2BackFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CreditCard2BackFillIcon.displayName = 'CreditCard2BackFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<TicketDetailedIcon />}>Click me</Button>
 * ```
 *
...
export const TicketDetailedIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TicketDetailedIcon.displayName = 'TicketDetailedIcon';

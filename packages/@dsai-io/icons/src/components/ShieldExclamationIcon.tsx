 ...
 *
 * Bootstrap Icons - Shield exclamation
 * @category Security
 * @tags privacy
 * @see https://icons.getbootstrap.com/icons/shield-exclamation/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ShieldExclamationIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ShieldExclamationIcon aria-label="Shield exclamation" />
 * ```
 */
...
export const ShieldExclamationIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

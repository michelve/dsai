 ...
 * CollectionPlayIcon
 *
 * Bootstrap Icons - Collection play
 * @category Media
 * @tags library
 * @see https://icons.getbootstrap.com/icons/collection-play/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CollectionPlayIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CollectionPlayIcon aria-label="Collection play" />
 * ```
 */
...
export const CollectionPlayIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
CollectionPlayIcon.displayName = 'CollectionPlayIcon';

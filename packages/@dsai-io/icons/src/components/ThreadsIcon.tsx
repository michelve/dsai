 ...
 * ThreadsIcon
 *
 * Bootstrap Icons - Threads
 * @category Brand
 * @tags social
 * @see https://icons.getbootstrap.com/icons/threads/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ThreadsIcon />}>Click me</Button>
 * ```
 *
...
export const ThreadsIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

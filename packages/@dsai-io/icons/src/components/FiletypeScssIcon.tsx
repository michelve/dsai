 ...
 * FiletypeScssIcon
 *
 * Bootstrap Icons - Filetype scss
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-scss/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeScssIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeScssIcon aria-label="Filetype scss" />
 * ```
 */
...
export const FiletypeScssIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FiletypeScssIcon.displayName = 'FiletypeScssIcon';

 ...
 * ```tsx
 * <Button startIcon={<FiletypeMp3Icon />}>Click me</Button>
 * ```
 *
...
export const FiletypeMp3Icon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FiletypeMp3Icon.displayName = 'FiletypeMp3Icon';

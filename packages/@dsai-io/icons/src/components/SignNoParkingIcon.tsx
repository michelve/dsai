 ...
 * SignNoParkingIcon
 *
 * Bootstrap Icons - Sign no parking
 * @category Transportation
 * @tags road
 * @see https://icons.getbootstrap.com/icons/sign-no-parking/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignNoParkingIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignNoParkingIcon aria-label="Sign no parking" />
 * ```
 */
...
export const SignNoParkingIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignNoParkingIcon.displayName = 'SignNoParkingIcon';

 ...
 * StoplightsIcon
 *
 * Bootstrap Icons - Stoplights
 * @category Real world
 * @tags traffic
 * @see https://icons.getbootstrap.com/icons/stoplights/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<StoplightsIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <StoplightsIcon aria-label="Stoplights" />
 * ```
 */
...
export const StoplightsIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
StoplightsIcon.displayName = 'StoplightsIcon';

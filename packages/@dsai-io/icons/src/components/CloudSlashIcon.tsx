 ...
 * CloudSlashIcon
 *
 * Bootstrap Icons - Cloud slash
 * @category Clouds
 * @tags cloud
 * @see https://icons.getbootstrap.com/icons/cloud-slash/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudSlashIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudSlashIcon aria-label="Cloud slash" />
 * ```
 */
...
export const CloudSlashIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

 ...
 * BrowserEdgeIcon
 *
 * Bootstrap Icons - Browser Edge
 * @category Brand
 * @tags microsoft
 * @see https://icons.getbootstrap.com/icons/browser-edge/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BrowserEdgeIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BrowserEdgeIcon aria-label="Browser Edge" />
 * ```
 */
...
export const BrowserEdgeIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BrowserEdgeIcon.displayName = 'BrowserEdgeIcon';

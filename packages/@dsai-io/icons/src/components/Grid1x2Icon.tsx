 ...
 * ```tsx
 * <Button startIcon={<Grid1x2Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Grid1x2Icon aria-label="Grid1x2" />
 * ```
 */
...
export const Grid1x2Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Grid1x2Icon.displayName = 'Grid1x2Icon';

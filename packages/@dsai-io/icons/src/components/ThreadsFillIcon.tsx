 ...
 * ```tsx
 * <Button startIcon={<ThreadsFillIcon />}>Click me</Button>
 * ```
 *
...
export const ThreadsFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ThreadsFillIcon.displayName = 'ThreadsFillIcon';

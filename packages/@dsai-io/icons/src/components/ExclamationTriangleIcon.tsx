 ...
 * @tags alert
 * @see https://icons.getbootstrap.com/icons/exclamation-triangle/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ExclamationTriangleIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ExclamationTriangleIcon aria-label="Exclamation triangle" />
 * ```
 */
...
export const ExclamationTriangleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * FiletypeSqlIcon
 *
 * Bootstrap Icons - Filetype SQL
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-sql/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeSqlIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeSqlIcon aria-label="Filetype SQL" />
 * ```
 */
...
export const FiletypeSqlIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

 ...
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/0-circle/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon0CircleIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon0CircleIcon aria-label="0 circle" />
 * ```
 */
...
export const Icon0CircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon0CircleIcon.displayName = 'Icon0CircleIcon';

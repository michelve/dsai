 ...
 * HeartHalfIcon
 *
 * Bootstrap Icons - Heart half
 * @category Shapes
 * @tags love
 * @see https://icons.getbootstrap.com/icons/heart-half/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HeartHalfIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HeartHalfIcon aria-label="Heart half" />
 * ```
 */
...
export const HeartHalfIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

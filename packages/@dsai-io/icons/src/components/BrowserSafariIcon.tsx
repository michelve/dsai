 ...
 * ```tsx
 * <Button startIcon={<BrowserSafariIcon />}>Click me</Button>
 * ```
 *
...
export const BrowserSafariIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
BrowserSafariIcon.displayName = 'BrowserSafariIcon';

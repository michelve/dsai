 ...
 * NodeMinusFillIcon
 *
 * Bootstrap Icons - Node minus fill
 * @category Graphics
 * @tags add
 * @see https://icons.getbootstrap.com/icons/node-minus-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<NodeMinusFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <NodeMinusFillIcon aria-label="Node minus fill" />
 * ```
 */
...
export const NodeMinusFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
NodeMinusFillIcon.displayName = 'NodeMinusFillIcon';

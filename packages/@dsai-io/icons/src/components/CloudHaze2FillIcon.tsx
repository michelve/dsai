 ...
 * CloudHaze2FillIcon
 *
 * Bootstrap Icons - Cloud haze2 fill
 * @category Weather
 * @tags smog
 * @see https://icons.getbootstrap.com/icons/cloud-haze2-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudHaze2FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudHaze2FillIcon aria-label="Cloud haze2 fill" />
 * ```
 */
...
export const CloudHaze2FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudHaze2FillIcon.displayName = 'CloudHaze2FillIcon';

 ...
 * CurrencyPoundIcon
 *
 * Bootstrap Icons - Currency pound
 * @category Commerce
 * @tags money
 * @see https://icons.getbootstrap.com/icons/currency-pound/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CurrencyPoundIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CurrencyPoundIcon aria-label="Currency pound" />
 * ```
 */
...
export const CurrencyPoundIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

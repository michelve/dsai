 ...
 * ```tsx
 * <Button startIcon={<Dice2FillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Dice2FillIcon aria-label="Dice2Fill" />
 * ```
 */
...
export const Dice2FillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Dice2FillIcon.displayName = 'Dice2FillIcon';

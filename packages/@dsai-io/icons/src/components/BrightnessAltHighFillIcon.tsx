 ...
 * ```tsx
 * <Button startIcon={<BrightnessAltHighFillIcon />}>Click me</Button>
 * ```
 *
...
export const BrightnessAltHighFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BrightnessAltHighFillIcon.displayName = 'BrightnessAltHighFillIcon';

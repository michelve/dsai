 ...
 * SignRailroadIcon
 *
 * Bootstrap Icons - Sign railroad
 * @category Transportation
 * @tags road
 * @see https://icons.getbootstrap.com/icons/sign-railroad/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignRailroadIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignRailroadIcon aria-label="Sign railroad" />
 * ```
 */
...
export const SignRailroadIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
SignRailroadIcon.displayName = 'SignRailroadIcon';

 ...
 * BadgeHdFillIcon
 *
 * Bootstrap Icons - Badge hd fill
 * @category Badges
 * @tags display
 * @see https://icons.getbootstrap.com/icons/badge-hd-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BadgeHdFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BadgeHdFillIcon aria-label="Badge hd fill" />
 * ```
 */
...
export const BadgeHdFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BadgeHdFillIcon.displayName = 'BadgeHdFillIcon';

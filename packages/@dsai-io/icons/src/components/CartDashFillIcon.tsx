 ...
 * CartDashFillIcon
 *
 * Bootstrap Icons - Cart dash fill
 * @category Commerce
 * @tags shopping
 * @see https://icons.getbootstrap.com/icons/cart-dash-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CartDashFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CartDashFillIcon aria-label="Cart dash fill" />
 * ```
 */
...
export const CartDashFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CartDashFillIcon.displayName = 'CartDashFillIcon';

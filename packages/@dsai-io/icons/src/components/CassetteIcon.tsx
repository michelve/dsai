 ...
 * CassetteIcon
 *
 * Bootstrap Icons - Cassette
 * @category Media
 * @tags tape
 * @see https://icons.getbootstrap.com/icons/cassette/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CassetteIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CassetteIcon aria-label="Cassette" />
 * ```
 */
...
export const CassetteIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

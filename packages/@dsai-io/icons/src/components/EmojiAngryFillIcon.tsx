 ...
 * ```tsx
 * <Button startIcon={<EmojiAngryFillIcon />}>Click me</Button>
 * ```
 *
...
export const EmojiAngryFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EmojiAngryFillIcon.displayName = 'EmojiAngryFillIcon';

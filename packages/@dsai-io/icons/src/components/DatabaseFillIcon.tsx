 ...
 * ```tsx
 * <Button startIcon={<DatabaseFillIcon />}>Click me</Button>
 * ```
 *
...
export const DatabaseFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DatabaseFillIcon.displayName = 'DatabaseFillIcon';

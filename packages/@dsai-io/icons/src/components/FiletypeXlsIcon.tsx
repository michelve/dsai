 ...
 * FiletypeXlsIcon
 *
 * Bootstrap Icons - Filetype xls
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-xls/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeXlsIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeXlsIcon aria-label="Filetype xls" />
 * ```
 */
...
export const FiletypeXlsIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

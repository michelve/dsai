 ...
 * PatchMinusFillIcon
 *
 * Bootstrap Icons - Patch minus fill
 * @category Badges
 * @tags subtract
 * @see https://icons.getbootstrap.com/icons/patch-minus-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PatchMinusFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PatchMinusFillIcon aria-label="Patch minus fill" />
 * ```
 */
...
export const PatchMinusFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PatchMinusFillIcon.displayName = 'PatchMinusFillIcon';

 ...
 *
 * Bootstrap Icons - Bookmark check fill
 * @category Miscellaneous
 * @tags reading
 * @see https://icons.getbootstrap.com/icons/bookmark-check-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BookmarkCheckFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BookmarkCheckFillIcon aria-label="Bookmark check fill" />
 * ```
 */
...
export const BookmarkCheckFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BookmarkCheckFillIcon.displayName = 'BookmarkCheckFillIcon';

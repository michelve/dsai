 ...
 *
 * Bootstrap Icons - Calendar2 heart fill
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar2-heart-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Calendar2HeartFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Calendar2HeartFillIcon aria-label="Calendar2 heart fill" />
 * ```
 */
...
export const Calendar2HeartFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Calendar2HeartFillIcon.displayName = 'Calendar2HeartFillIcon';

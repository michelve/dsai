 ...
 * ```tsx
 * <Button startIcon={<PaletteFillIcon />}>Click me</Button>
 * ```
 *
...
export const PaletteFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PaletteFillIcon.displayName = 'PaletteFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<FileSlidesFillIcon />}>Click me</Button>
 * ```
 *
...
export const FileSlidesFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FileSlidesFillIcon.displayName = 'FileSlidesFillIcon';

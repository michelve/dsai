 ...
 * SignYieldIcon
 *
 * Bootstrap Icons - Sign yield
 * @category Transportation
 * @tags road
 * @see https://icons.getbootstrap.com/icons/sign-yield/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignYieldIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignYieldIcon aria-label="Sign yield" />
 * ```
 */
...
export const SignYieldIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
SignYieldIcon.displayName = 'SignYieldIcon';

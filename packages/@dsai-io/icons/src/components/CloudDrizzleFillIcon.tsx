 ...
 * ```tsx
 * <Button startIcon={<CloudDrizzleFillIcon />}>Click me</Button>
 * ```
 *
...
export const CloudDrizzleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudDrizzleFillIcon.displayName = 'CloudDrizzleFillIcon';

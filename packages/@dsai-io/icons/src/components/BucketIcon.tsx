 ...
 * BucketIcon
 *
 * Bootstrap Icons - Bucket
 * @category Tools
 * @tags tool
 * @see https://icons.getbootstrap.com/icons/bucket/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BucketIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BucketIcon aria-label="Bucket" />
 * ```
 */
...
export const BucketIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * Grid3x2GapFillIcon
 *
 * Bootstrap Icons - Grid3x2GapFill
 ...
 * ```tsx
 * <Button startIcon={<Grid3x2GapFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Grid3x2GapFillIcon aria-label="Grid3x2GapFill" />
 * ```
 */
...
export const Grid3x2GapFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Grid3x2GapFillIcon.displayName = 'Grid3x2GapFillIcon';

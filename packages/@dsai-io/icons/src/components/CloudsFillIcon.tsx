 ...
 * CloudsFillIcon
 *
 * Bootstrap Icons - Clouds fill
 * @category Weather
 * @tags clouds
 * @see https://icons.getbootstrap.com/icons/clouds-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudsFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudsFillIcon aria-label="Clouds fill" />
 * ```
 */
...
export const CloudsFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudsFillIcon.displayName = 'CloudsFillIcon';

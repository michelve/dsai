 ...
 * Icon8CircleFillIcon
 *
 * Bootstrap Icons - 8 circle fill
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/8-circle-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon8CircleFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon8CircleFillIcon aria-label="8 circle fill" />
 * ```
 */
...
export const Icon8CircleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
Icon8CircleFillIcon.displayName = 'Icon8CircleFillIcon';

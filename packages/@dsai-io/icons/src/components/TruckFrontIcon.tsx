 ...
 * TruckFrontIcon
 *
 * Bootstrap Icons - Truck front
 * @category Transportation
 * @tags vehicle
 * @see https://icons.getbootstrap.com/icons/truck-front/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TruckFrontIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TruckFrontIcon aria-label="Truck front" />
 * ```
 */
...
export const TruckFrontIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TruckFrontIcon.displayName = 'TruckFrontIcon';

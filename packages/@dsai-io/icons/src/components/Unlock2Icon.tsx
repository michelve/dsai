 ...
 * Unlock2Icon
 *
 * Bootstrap Icons - Unlock2
 * @category Security
 * @tags privacy
 * @see https://icons.getbootstrap.com/icons/unlock2/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Unlock2Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Unlock2Icon aria-label="Unlock2" />
 * ```
 */
...
export const Unlock2Icon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
Unlock2Icon.displayName = 'Unlock2Icon';

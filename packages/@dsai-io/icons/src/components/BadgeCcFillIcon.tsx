 ...
 * BadgeCcFillIcon
 *
 * Bootstrap Icons - Badge cc fill
 * @category Badges
 * @tags "closed captioning"
 * @see https://icons.getbootstrap.com/icons/badge-cc-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BadgeCcFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BadgeCcFillIcon aria-label="Badge cc fill" />
 * ```
 */
...
export const BadgeCcFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BadgeCcFillIcon.displayName = 'BadgeCcFillIcon';

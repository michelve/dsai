 ...
 * ```tsx
 * <Button startIcon={<FiletypeMovIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypeMovIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FiletypeMovIcon.displayName = 'FiletypeMovIcon';

 ...
 * CupHotFillIcon
 *
 * Bootstrap Icons - Cup hot fill
 * @category Real world
 * @tags mug
 * @see https://icons.getbootstrap.com/icons/cup-hot-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CupHotFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CupHotFillIcon aria-label="Cup hot fill" />
 * ```
 */
...
export const CupHotFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CupHotFillIcon.displayName = 'CupHotFillIcon';

 ...
 * ExplicitIcon
 *
 * Bootstrap Icons - Explicit
 * @category Badges
 * @tags r18
 * @see https://icons.getbootstrap.com/icons/explicit/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ExplicitIcon />}>Click me</Button>
 * ```
 *
...
export const ExplicitIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

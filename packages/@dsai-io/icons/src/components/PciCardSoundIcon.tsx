 ...
 * ```tsx
 * <Button startIcon={<PciCardSoundIcon />}>Click me</Button>
 * ```
 *
...
export const PciCardSoundIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PciCardSoundIcon.displayName = 'PciCardSoundIcon';

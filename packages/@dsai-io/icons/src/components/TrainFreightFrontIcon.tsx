 ...
 * ```tsx
 * <Button startIcon={<TrainFreightFrontIcon />}>Click me</Button>
 * ```
 *
...
export const TrainFreightFrontIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TrainFreightFrontIcon.displayName = 'TrainFreightFrontIcon';

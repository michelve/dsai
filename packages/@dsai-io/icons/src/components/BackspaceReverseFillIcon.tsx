 ...
 * ```tsx
 * <Button startIcon={<BackspaceReverseFillIcon />}>Click me</Button>
 * ```
 *
...
export const BackspaceReverseFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BackspaceReverseFillIcon.displayName = 'BackspaceReverseFillIcon';

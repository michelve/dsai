 ...
 *
 * Bootstrap Icons - File earmark check fill
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-earmark-check-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FileEarmarkCheckFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FileEarmarkCheckFillIcon aria-label="File earmark check fill" />
 * ```
 */
...
export const FileEarmarkCheckFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FileEarmarkCheckFillIcon.displayName = 'FileEarmarkCheckFillIcon';

 ...
 *
 * Bootstrap Icons - Clipboard2 pulse fill
 * @category Real world
 * @tags copy
 * @see https://icons.getbootstrap.com/icons/clipboard2-pulse-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Clipboard2PulseFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Clipboard2PulseFillIcon aria-label="Clipboard2 pulse fill" />
 * ```
 */
...
export const Clipboard2PulseFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
Clipboard2PulseFillIcon.displayName = 'Clipboard2PulseFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<GraphDownArrowIcon />}>Click me</Button>
 * ```
 *
...
export const GraphDownArrowIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
GraphDownArrowIcon.displayName = 'GraphDownArrowIcon';

 ...
 * SignTurnRightIcon
 *
 * Bootstrap Icons - Sign turn right
 * @category Transportation
 * @tags road
 * @see https://icons.getbootstrap.com/icons/sign-turn-right/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<SignTurnRightIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <SignTurnRightIcon aria-label="Sign turn right" />
 * ```
 */
...
export const SignTurnRightIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignTurnRightIcon.displayName = 'SignTurnRightIcon';

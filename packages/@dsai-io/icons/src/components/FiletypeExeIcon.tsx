 ...
 * ```tsx
 * <Button startIcon={<FiletypeExeIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypeExeIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
FiletypeExeIcon.displayName = 'FiletypeExeIcon';

 ...
 * ```tsx
 * <Button startIcon={<Calendar2DateFillIcon />}>Click me</Button>
 * ```
 *
...
export const Calendar2DateFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Calendar2DateFillIcon.displayName = 'Calendar2DateFillIcon';

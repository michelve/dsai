 ...
 * ```tsx
 * <Button startIcon={<SortAlphaDownIcon />}>Click me</Button>
 * ```
 *
...
export const SortAlphaDownIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SortAlphaDownIcon.displayName = 'SortAlphaDownIcon';

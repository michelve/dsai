 ...
 * Mailbox2Icon
 *
 * Bootstrap Icons - Mailbox2
 * @category Real world
 * @tags post
 * @see https://icons.getbootstrap.com/icons/mailbox2/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Mailbox2Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Mailbox2Icon aria-label="Mailbox2" />
 * ```
 */
...
export const Mailbox2Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Mailbox2Icon.displayName = 'Mailbox2Icon';

 ...
 * XboxIcon
 *
 * Bootstrap Icons - Xbox
 * @category Brand
 * @tags microsoft
 * @see https://icons.getbootstrap.com/icons/xbox/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<XboxIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <XboxIcon aria-label="Xbox" />
 * ```
 */
...
export const XboxIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

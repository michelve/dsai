 ...
 * BlockquoteLeftIcon
 *
 * Bootstrap Icons - Blockquote left
 * @category Typography
 * @tags text
 * @see https://icons.getbootstrap.com/icons/blockquote-left/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BlockquoteLeftIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BlockquoteLeftIcon aria-label="Blockquote left" />
 * ```
 */
...
export const BlockquoteLeftIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BlockquoteLeftIcon.displayName = 'BlockquoteLeftIcon';

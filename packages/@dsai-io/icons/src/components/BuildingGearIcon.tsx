 ...
 * @category Buildings
 * @tags company
 * @see https://icons.getbootstrap.com/icons/building-gear/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BuildingGearIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BuildingGearIcon aria-label="Building gear" />
 * ```
 */
...
export const BuildingGearIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
BuildingGearIcon.displayName = 'BuildingGearIcon';

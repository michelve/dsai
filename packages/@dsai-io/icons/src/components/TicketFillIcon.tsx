 ...
 * TicketFillIcon
 *
 * Bootstrap Icons - Ticket fill
 * @category Real world
 * @tags tickets
 * @see https://icons.getbootstrap.com/icons/ticket-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TicketFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TicketFillIcon aria-label="Ticket fill" />
 * ```
 */
...
export const TicketFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TicketFillIcon.displayName = 'TicketFillIcon';

 ...
 * ChatQuoteFillIcon
 *
 * Bootstrap Icons - Chat quote fill
 * @category Communications
 * @tags chat bubble
 * @see https://icons.getbootstrap.com/icons/chat-quote-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ChatQuoteFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ChatQuoteFillIcon aria-label="Chat quote fill" />
 * ```
 */
...
export const ChatQuoteFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
ChatQuoteFillIcon.displayName = 'ChatQuoteFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<GearWideConnectedIcon />}>Click me</Button>
 * ```
 *
...
export const GearWideConnectedIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
GearWideConnectedIcon.displayName = 'GearWideConnectedIcon';

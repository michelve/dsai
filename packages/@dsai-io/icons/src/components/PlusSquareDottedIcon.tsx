 ...
 * ```tsx
 * <Button startIcon={<PlusSquareDottedIcon />}>Click me</Button>
 * ```
 *
...
export const PlusSquareDottedIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PlusSquareDottedIcon.displayName = 'PlusSquareDottedIcon';

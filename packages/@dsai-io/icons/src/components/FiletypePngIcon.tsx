 ...
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-png/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypePngIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypePngIcon aria-label="Filetype png" />
 * ```
 */
...
export const FiletypePngIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

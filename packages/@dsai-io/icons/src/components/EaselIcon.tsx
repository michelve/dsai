 ...
 * EaselIcon
 *
 * Bootstrap Icons - Easel
 * @category Graphics
 * @tags paint
 * @see https://icons.getbootstrap.com/icons/easel/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<EaselIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <EaselIcon aria-label="Easel" />
 * ```
 */
...
export const EaselIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
EaselIcon.displayName = 'EaselIcon';

 ...
 * ```tsx
 * <Button startIcon={<BuildingExclamationIcon />}>Click me</Button>
 * ```
 *
...
export const BuildingExclamationIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
BuildingExclamationIcon.displayName = 'BuildingExclamationIcon';

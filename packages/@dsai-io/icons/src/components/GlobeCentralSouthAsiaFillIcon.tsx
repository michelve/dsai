 ...
 *
 * Bootstrap Icons - Globe Central South Asia fill
 * @category Geo
 * @tags geography
 * @see https://icons.getbootstrap.com/icons/globe-central-south-asia-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <GlobeCentralSouthAsiaFillIcon aria-label="Globe Central South Asia fill" />
 * ```
 */

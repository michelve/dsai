 ...
 * ```tsx
 * <Button startIcon={<ThermometerHalfIcon />}>Click me</Button>
 * ```
 *
...
export const ThermometerHalfIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ThermometerHalfIcon.displayName = 'ThermometerHalfIcon';

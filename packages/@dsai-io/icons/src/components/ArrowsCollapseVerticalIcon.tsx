 ...
 * ```tsx
 * <Button startIcon={<ArrowsCollapseVerticalIcon />}>Click me</Button>
 * ```
 *
...
export const ArrowsCollapseVerticalIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowsCollapseVerticalIcon.displayName = 'ArrowsCollapseVerticalIcon';

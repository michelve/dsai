 ...
 * Icon5SquareIcon
 *
 * Bootstrap Icons - 5 square
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/5-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon5SquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon5SquareIcon aria-label="5 square" />
 * ```
 */
...
export const Icon5SquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
Icon5SquareIcon.displayName = 'Icon5SquareIcon';

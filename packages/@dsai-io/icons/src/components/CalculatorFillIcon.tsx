 ...
 * CalculatorFillIcon
 *
 * Bootstrap Icons - Calculator fill
 * @category Devices
 * @tags calculator
 * @see https://icons.getbootstrap.com/icons/calculator-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CalculatorFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CalculatorFillIcon aria-label="Calculator fill" />
 * ```
 */
...
export const CalculatorFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
CalculatorFillIcon.displayName = 'CalculatorFillIcon';

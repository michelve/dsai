 ...
 * CalendarDayIcon
 *
 * Bootstrap Icons - Calendar day
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar-day/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CalendarDayIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CalendarDayIcon aria-label="Calendar day" />
 * ```
 */
...
export const CalendarDayIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,

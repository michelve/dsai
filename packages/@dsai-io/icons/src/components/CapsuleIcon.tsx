 ...
 * @category Medical
 * @tags rx
 * @see https://icons.getbootstrap.com/icons/capsule/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CapsuleIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CapsuleIcon aria-label="Capsule" />
 * ```
 */
...
export const CapsuleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

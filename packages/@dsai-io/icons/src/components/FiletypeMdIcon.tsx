 ...
 * ```tsx
 * <Button startIcon={<FiletypeMdIcon />}>Click me</Button>
 * ```
 *
...
export const FiletypeMdIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FiletypeMdIcon.displayName = 'FiletypeMdIcon';

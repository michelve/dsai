 ...
 * ```tsx
 * <Button startIcon={<ArrowRepeatIcon />}>Click me</Button>
 * ```
 *
...
export const ArrowRepeatIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ArrowRepeatIcon.displayName = 'ArrowRepeatIcon';

 ...
 * ThermometerLowIcon
 *
 * Bootstrap Icons - Thermometer low
 * @category Weather
 * @tags temperature
 * @see https://icons.getbootstrap.com/icons/thermometer-low/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ThermometerLowIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ThermometerLowIcon aria-label="Thermometer low" />
 * ```
 */
...
export const ThermometerLowIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

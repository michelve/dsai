 ...
 * UsbPlugFillIcon
 *
 * Bootstrap Icons - USB plug fill
 * @category Devices
 * @tags port
 * @see https://icons.getbootstrap.com/icons/usb-plug-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<UsbPlugFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <UsbPlugFillIcon aria-label="USB plug fill" />
 * ```
 */
...
export const UsbPlugFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
UsbPlugFillIcon.displayName = 'UsbPlugFillIcon';

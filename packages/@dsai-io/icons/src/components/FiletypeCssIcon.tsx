 ...
 * FiletypeCssIcon
 *
 * Bootstrap Icons - Filetype css
 * @category Files and folders
 * @tags file
 * @see https://icons.getbootstrap.com/icons/filetype-css/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FiletypeCssIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FiletypeCssIcon aria-label="Filetype css" />
 * ```
 */
...
export const FiletypeCssIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

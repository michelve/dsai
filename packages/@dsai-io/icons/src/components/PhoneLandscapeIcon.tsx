 ...
 * PhoneLandscapeIcon
 *
 * Bootstrap Icons - Phone landscape
 * @category Devices
 * @tags mobile
 * @see https://icons.getbootstrap.com/icons/phone-landscape/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PhoneLandscapeIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PhoneLandscapeIcon aria-label="Phone landscape" />
 * ```
 */
...
export const PhoneLandscapeIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PhoneLandscapeIcon.displayName = 'PhoneLandscapeIcon';

 ...
 * LuggageFillIcon
 *
 * Bootstrap Icons - Luggage fill
 * @category Travel
 * @tags luggage
 * @see https://icons.getbootstrap.com/icons/luggage-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<LuggageFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <LuggageFillIcon aria-label="Luggage fill" />
 * ```
 */
...
export const LuggageFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
LuggageFillIcon.displayName = 'LuggageFillIcon';

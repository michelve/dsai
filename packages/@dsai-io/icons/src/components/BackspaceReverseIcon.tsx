 ...
 *
 * Bootstrap Icons - Backspace reverse
 * @category UI and keyboard
 * @tags key
 * @see https://icons.getbootstrap.com/icons/backspace-reverse/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<BackspaceReverseIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <BackspaceReverseIcon aria-label="Backspace reverse" />
 * ```
 */
...
export const BackspaceReverseIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<SkipEndCircleFillIcon />}>Click me</Button>
 * ```
 *
...
export const SkipEndCircleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SkipEndCircleFillIcon.displayName = 'SkipEndCircleFillIcon';

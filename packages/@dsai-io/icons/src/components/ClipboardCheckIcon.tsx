 ...
 * @category Real world
 * @tags copy
 * @see https://icons.getbootstrap.com/icons/clipboard-check/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ClipboardCheckIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ClipboardCheckIcon aria-label="Clipboard check" />
 * ```
 */

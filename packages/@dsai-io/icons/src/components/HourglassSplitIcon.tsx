 ...
 * ```tsx
 * <Button startIcon={<HourglassSplitIcon />}>Click me</Button>
 * ```
 *
...
export const HourglassSplitIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
HourglassSplitIcon.displayName = 'HourglassSplitIcon';

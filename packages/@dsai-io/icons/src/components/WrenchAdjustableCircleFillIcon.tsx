 ...
 *
 * Bootstrap Icons - Wrench adjustable circle fill
 * @category Tools
 * @tags tool
 * @see https://icons.getbootstrap.com/icons/wrench-adjustable-circle-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<WrenchAdjustableCircleFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <WrenchAdjustableCircleFillIcon aria-label="Wrench adjustable circle fill" />
 * ```
 */
...
export const WrenchAdjustableCircleFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
WrenchAdjustableCircleFillIcon.displayName = 'WrenchAdjustableCircleFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<Grid3x2Icon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Grid3x2Icon aria-label="Grid3x2" />
 * ```
 */
...
export const Grid3x2Icon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

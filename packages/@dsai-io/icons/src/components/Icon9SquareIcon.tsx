 ...
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/9-square/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon9SquareIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon9SquareIcon aria-label="9 square" />
 * ```
 */
...
export const Icon9SquareIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon9SquareIcon.displayName = 'Icon9SquareIcon';

 ...
 * ```tsx
 * <Button startIcon={<DatabaseSlashIcon />}>Click me</Button>
 * ```
 *
...
export const DatabaseSlashIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
DatabaseSlashIcon.displayName = 'DatabaseSlashIcon';

 ...
 * ```tsx
 * <Button startIcon={<CardHeadingIcon />}>Click me</Button>
 * ```
 *
...
export const CardHeadingIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CardHeadingIcon.displayName = 'CardHeadingIcon';

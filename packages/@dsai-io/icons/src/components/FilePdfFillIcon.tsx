 ...
 * FilePdfFillIcon
 *
 * Bootstrap Icons - File PDF fill
 * @category Files and folders
 * @tags doc
 * @see https://icons.getbootstrap.com/icons/file-pdf-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<FilePdfFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <FilePdfFillIcon aria-label="File PDF fill" />
 * ```
 */
...
export const FilePdfFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
FilePdfFillIcon.displayName = 'FilePdfFillIcon';

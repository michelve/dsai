 ...
 *
 * Bootstrap Icons - Cloud rain heavy fill
 * @category Weather
 * @tags cloud
 * @see https://icons.getbootstrap.com/icons/cloud-rain-heavy-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudRainHeavyFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudRainHeavyFillIcon aria-label="Cloud rain heavy fill" />
 * ```
 */
...
export const CloudRainHeavyFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CloudRainHeavyFillIcon.displayName = 'CloudRainHeavyFillIcon';

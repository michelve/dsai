 ...
 * ```tsx
 * <Button startIcon={<TerminalSplitIcon />}>Click me</Button>
 * ```
 *
...
export const TerminalSplitIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TerminalSplitIcon.displayName = 'TerminalSplitIcon';

 ...
 * GenderTransIcon
 *
 * Bootstrap Icons - Gender trans
 * @category People
 * @tags gender
 * @see https://icons.getbootstrap.com/icons/gender-trans/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<GenderTransIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <GenderTransIcon aria-label="Gender trans" />
 * ```
 */
...
export const GenderTransIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
GenderTransIcon.displayName = 'GenderTransIcon';

 ...
 *
 * Bootstrap Icons - Calendar month fill
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar-month-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CalendarMonthFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CalendarMonthFillIcon aria-label="Calendar month fill" />
 * ```
 */
...
export const CalendarMonthFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
CalendarMonthFillIcon.displayName = 'CalendarMonthFillIcon';

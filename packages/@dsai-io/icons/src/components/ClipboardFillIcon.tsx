 ...
 * ClipboardFillIcon
 *
 * Bootstrap Icons - Clipboard fill
 * @category Real world
 * @tags copy
 * @see https://icons.getbootstrap.com/icons/clipboard-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ClipboardFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ClipboardFillIcon aria-label="Clipboard fill" />
 * ```
 */
...
export const ClipboardFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
ClipboardFillIcon.displayName = 'ClipboardFillIcon';

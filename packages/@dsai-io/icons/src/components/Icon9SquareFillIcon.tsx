 ...
 * Icon9SquareFillIcon
 *
 * Bootstrap Icons - 9 square fill
 * @category Shapes
 * @tags number
 * @see https://icons.getbootstrap.com/icons/9-square-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<Icon9SquareFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <Icon9SquareFillIcon aria-label="9 square fill" />
 * ```
 */
...
export const Icon9SquareFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon9SquareFillIcon.displayName = 'Icon9SquareFillIcon';

 ...
 * ```tsx
 * <Button startIcon={<Icon2CircleIcon />}>Click me</Button>
 * ```
 *
...
export const Icon2CircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon2CircleIcon.displayName = 'Icon2CircleIcon';

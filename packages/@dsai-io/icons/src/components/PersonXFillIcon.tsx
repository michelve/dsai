 ...
 * PersonXFillIcon
 *
 * Bootstrap Icons - Person x fill
 * @category People
 * @tags member
 * @see https://icons.getbootstrap.com/icons/person-x-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<PersonXFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <PersonXFillIcon aria-label="Person x fill" />
 * ```
 */
...
export const PersonXFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
PersonXFillIcon.displayName = 'PersonXFillIcon';

 ...
 *
 * Bootstrap Icons - Ticket detailed fill
 * @category Real world
 * @tags tickets
 * @see https://icons.getbootstrap.com/icons/ticket-detailed-fill/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TicketDetailedFillIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TicketDetailedFillIcon aria-label="Ticket detailed fill" />
 * ```
 */
...
export const TicketDetailedFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
TicketDetailedFillIcon.displayName = 'TicketDetailedFillIcon';

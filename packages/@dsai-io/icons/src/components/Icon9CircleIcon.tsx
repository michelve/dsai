 ...
 * ```tsx
 * <Button startIcon={<Icon9CircleIcon />}>Click me</Button>
 * ```
 *
...
export const Icon9CircleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
Icon9CircleIcon.displayName = 'Icon9CircleIcon';

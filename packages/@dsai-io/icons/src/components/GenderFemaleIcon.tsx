 ...
 * @category People
 * @tags gender
 * @see https://icons.getbootstrap.com/icons/gender-female/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<GenderFemaleIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <GenderFemaleIcon aria-label="Gender female" />
 * ```
 */
...
export const GenderFemaleIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * ```tsx
 * <Button startIcon={<CollectionPlayFillIcon />}>Click me</Button>
 * ```
 *
...
export const CollectionPlayFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
CollectionPlayFillIcon.displayName = 'CollectionPlayFillIcon';

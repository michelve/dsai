 ...
 * ArrowUpLeftIcon
 *
 * Bootstrap Icons - Arrow up-left
 * @category Arrows
 * @tags arrow
 * @see https://icons.getbootstrap.com/icons/arrow-up-left/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<ArrowUpLeftIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <ArrowUpLeftIcon aria-label="Arrow up-left" />
 * ```
 */

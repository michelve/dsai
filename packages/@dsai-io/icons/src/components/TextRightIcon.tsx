 ...
 * @category Typography
 * @tags text
 * @see https://icons.getbootstrap.com/icons/text-right/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<TextRightIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <TextRightIcon aria-label="Text right" />
 * ```
 */
...
export const TextRightIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

 ...
 * CalendarHeartIcon
 *
 * Bootstrap Icons - Calendar heart
 * @category Date and time
 * @tags date
 * @see https://icons.getbootstrap.com/icons/calendar-heart/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CalendarHeartIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CalendarHeartIcon aria-label="Calendar heart" />
 * ```
 */
...
export const CalendarHeartIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

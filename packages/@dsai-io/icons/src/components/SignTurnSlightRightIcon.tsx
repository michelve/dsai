 ...
 * ```tsx
 * <Button startIcon={<SignTurnSlightRightIcon />}>Click me</Button>
 * ```
 *
...
export const SignTurnSlightRightIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
SignTurnSlightRightIcon.displayName = 'SignTurnSlightRightIcon';

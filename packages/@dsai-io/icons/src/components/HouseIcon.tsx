 ...
 * @category Real world
 * @tags home
 * @see https://icons.getbootstrap.com/icons/house/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<HouseIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <HouseIcon aria-label="House" />
 * ```
 */
...
export const HouseIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',

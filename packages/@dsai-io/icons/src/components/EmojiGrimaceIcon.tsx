 ...
 * ```tsx
 * <Button startIcon={<EmojiGrimaceIcon />}>Click me</Button>
 * ```
 *
...
export const EmojiGrimaceIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      color,
      className,
...
EmojiGrimaceIcon.displayName = 'EmojiGrimaceIcon';

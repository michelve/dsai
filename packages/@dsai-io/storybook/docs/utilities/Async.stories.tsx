          ...
          >
            <div>
              <label
                ...
                style={{ display: 'block', marginBottom: '0.5rem', fontWeight: FONT_WEIGHT_MEDIUM }}
              >
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '800px' }}>
        ...
        >
          ...
          >
            <div>
              <label style={{ display: 'block', fontWeight: FONT_WEIGHT_MEDIUM }}>
            ...
            <div>
              <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                />
                <span style={{ fontWeight: FONT_WEIGHT_MEDIUM }}>Enable Jitter (±25%)</span>
              </label>
              <p
          ...
          <div style={{ marginTop: '1rem' }}>
            {delays.map((delay, attempt) => {
              ...
              return (
                ...
                >
                  <span style={{ width: '80px', fontWeight: FONT_WEIGHT_MEDIUM }}>Attempt {attempt + 1}</span>
                  <div
                    style={{
                      flex: 1,
                      height: '24px',
...
export const CreateTaskQueueDemo: Story = {
  ...
  render: function Render(): JSX.Element {
    ...
    const addTask = (priority = 0): void => {
      const BASE_36 = 36;
      const TASK_ID_START = 2;
      const TASK_ID_END = 6;
      const TASK_DURATION_MS = 1500;
      const taskId = Math.random().toString(BASE_36).slice(TASK_ID_START, TASK_ID_END).toUpperCase();

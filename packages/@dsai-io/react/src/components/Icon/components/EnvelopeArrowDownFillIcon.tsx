 ...
 * ```tsx
 * <Button startIcon={<EnvelopeArrowDownFillIcon />}>Click me</Button>
 * ```
 *
...
export const EnvelopeArrowDownFillIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
EnvelopeArrowDownFillIcon.displayName = 'EnvelopeArrowDownFillIcon';

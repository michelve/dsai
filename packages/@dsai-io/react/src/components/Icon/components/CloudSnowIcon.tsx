 ...
 * CloudSnowIcon
 *
 * Bootstrap Icons - Cloud snow
 * @category Weather
 * @tags cloud
 * @see https://icons.getbootstrap.com/icons/cloud-snow/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<CloudSnowIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <CloudSnowIcon aria-label="Cloud snow" />
 * ```
 */

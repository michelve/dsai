 ...
 * DiamondHalfIcon
 *
 * Bootstrap Icons - Diamond half fill
 * @category Shapes
 * @tags shape
 * @see https://icons.getbootstrap.com/icons/diamond-half/
 *
 * @accessibility
 ...
 * ```tsx
 * <Button startIcon={<DiamondHalfIcon />}>Click me</Button>
 * ```
 *
 * @example Semantic (standalone)
 * ```tsx
 * <DiamondHalfIcon aria-label="Diamond half fill" />
 * ```
 */
...
export const DiamondHalfIcon = forwardRef<SVGSVGElement, IconProps>(
  (
    {
      size = 16,
      color = 'currentColor',
...
DiamondHalfIcon.displayName = 'DiamondHalfIcon';
